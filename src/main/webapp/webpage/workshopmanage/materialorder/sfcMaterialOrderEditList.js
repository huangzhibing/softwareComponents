...
$(document).ready(function() {
	$('#sfcMaterialOrderTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/materialorder/sfcMaterialOrder/editData",
			...
			,{
		        ...
		        ,formatter:function(value, row , index){
		        	return "<a href='${ctx}/materialorder/sfcMaterialOrder/editForm?id="+row.id+"'>"+value+"</a>";
		         }
		    }
  ...
  function edit(){
	  window.location = "${ctx}/materialorder/sfcMaterialOrder/editForm?id=" + getIdSelections();
  }
  function manualAdd() {
  	window.location = "${ctx}/materialorder/sfcMaterialOrder/newForm";

  }

  function generalAdd() {
      jp.openDialog('生成集中领料单', "${ctx}/materialorder/sfcMaterialOrder/genForm",'500px', '350px', $('#sfcMaterialOrderTable'));
  }
