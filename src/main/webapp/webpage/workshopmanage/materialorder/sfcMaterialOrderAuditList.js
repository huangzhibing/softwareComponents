...
$(document).ready(function() {
	$('#sfcMaterialOrderTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/materialorder/sfcMaterialOrder/auditData",
			...
			,{
		        ...
		        ,formatter:function(value, row , index){
		        	return "<a href='${ctx}/materialorder/sfcMaterialOrder/auditForm?id="+row.id+"'>"+value+"</a>";
		         }
		    }
  ...
  function edit(){
	  window.location = "${ctx}/materialorder/sfcMaterialOrder/auditForm?id=" + getIdSelections();
  }
