	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/materialorder/sfcMaterialOrder/queryList"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="sfcMaterialOrder" action="${ctx}/materialorder/sfcMaterialOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					...
					<label class="col-sm-2 control-label"><font color="red">*</font>领料类型：</label>
					<div class="col-sm-3">
						<form:select path="billType" class="form-control " disabled="true" >
					...
					<div class="col-sm-3">
						<p class="input-group">
							<div class='input-group form_datetime' id='operDate'>
			                    <input type='text'  name="operDate" class="form-control required" readonly="true" value="<fmt:formatDate value="${sfcMaterialOrder.operDate}" pattern="yyyy-MM-dd"/>"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<form:input path="wareId" htmlEscape="false"  readonly="true"  class="form-control required"/>
					</div>--%>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<form:input path="wareEmpid" htmlEscape="false"  readonly="true"  class="form-control required"/>
					</div>--%>
					...
					<div class="col-sm-3">
						<form:input path="wareEmpname" htmlEscape="false"  readonly="true"  class="form-control required"/>
					</div>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">良品标识：</label>
					<div class="col-sm-3">
						<form:select path="qualityFlag" class="form-control " readonly="true">
							<form:option value="" label=""/>
			...
			<script type="text/template" id="sfcMaterialOrderDetailTpl">//<!--
				<tr id="sfcMaterialOrderDetailList{{idx}}">
					...
					<%--<td style=" width: 100px; ">
						<select id="sfcMaterialOrderDetailList{{idx}}_isLack" name="sfcMaterialOrderDetailList[{{idx}}].isLack" data-value="{{row.isLack}}"   readonly="true" class="form-control   ">
							<option value=""></option>
							<c:forEach items="${fns:getDictList('sfc_is_lack')}" var="dict">
					...
					<td>
						<input id="sfcMaterialOrderDetailList{{idx}}_lackQty" name="sfcMaterialOrderDetailList[{{idx}}].lackQty" type="text" value="{{row.lackQty}}"  readonly="true"  class="form-control "/>
					</td>--%>
				...
				<%--
					...
					<td>
						<textarea id="sfcMaterialOrderDetailList{{idx}}_remarks" name="sfcMaterialOrderDetailList[{{idx}}].remarks" rows="1"   readonly="true" class="form-control ">{{row.remarks}}</textarea>
					</td>
...
function submitBill(){
	jp.loading("正在提交...");
	form=$('#inputForm');
	jp.post("${ctx}/materialorder/sfcMaterialOrder/submit",$('#inputForm').serialize(),function(data){
		form.submit();
    });
	jp.close();
}
