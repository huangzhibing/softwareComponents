...
<head>
	...
	<%@include file="qmReportMachineList.js" %>
</head>
<body>
	...
	<div id="toolbar">
		<!--
			<shiro:hasPermission name="qmreport:qmReportMachine:add">
				<a id="add" class="btn btn-primary" href="${ctx}/qmreport/qmReportMachine/form" title="质量问题"> <i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="qmreport:qmReportMachine:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	 <i class="glyphicon glyphicon-edit"></i>  修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="qmreport:qmReportMachine:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	 <i class="glyphicon glyphicon-remove"></i>  删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="qmreport:qmReportMachine:list">
			    <button id="item_detail" class="btn btn-warning" onclick="itemDetail()">
	            	 <i class="glyphicon glyphicon-folder-open"></i>  详情
	        	</button>
			</shiro:hasPermission>
			-->
			<%-- <shiro:hasPermission name="qmreport:qmReportMachine:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/qmreport/qmReportMachine/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="qmReportTable1"   data-toolbar="#toolbar"></table>
