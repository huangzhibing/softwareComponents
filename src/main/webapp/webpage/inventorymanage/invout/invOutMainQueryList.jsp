...
<head>
	...
	<%@include file="invOutMainQueryList.js" %>
</head>
<body>
			...
			<form:form id="searchForm" modelAttribute="invOutMain" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="仓库编码：">仓库编码：</label>
										<sys:gridselect-modify targetField="aaa" targetId="aaa" url="${ctx}/warehouse/wareHouse/data" id="ware" name="ware.id" value="${invOutMain.ware.id}" labelName="ware.wareID" labelValue="${invOutMain.ware.wareID}"
