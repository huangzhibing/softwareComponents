	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/amountadjustment/amountAdjustment/auditList"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="billMain" action="${ctx}/amountadjustment/amountAdjustment/formAuditdo" method="post" class="form-horizontal">
		<form:hidden path="id"/>
