...
<body>
		...
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="billMain" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				 <div class="form-group">
					<label class="label-item single-overflow pull-left" title="出入库日期：">&nbsp;调整日期：</label>
					<div class="col-xs-12">
			...
			<input id="wareIDd" name="ware.wareID" style="display:none;"/>
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<sys:gridselect-modify extraField="wareEmpno:user.no" labelField="user.no" targetId="wareEmpname" targetField="empName" url="${ctx}/employee/employee/data" id="wareEmp" name="wareEmp.id" value="${billMain.wareEmp.id}" labelName="wareEmp.user.no" labelValue="${billMain.wareEmp.user.no}"
				...
				<input id="wareEmpno" name="wareEmp.user.no" style="display:none;"/>
			 <div class="col-xs-12 col-sm-6 col-md-4">
	...
	<div id="toolbar">
			<%-- <shiro:hasPermission name="billmain:billMain:add">
				<a id="add" class="btn btn-primary" href="${ctx}/amountadjustment/amountAdjustment/formAudit" title="单据"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission> --%>
