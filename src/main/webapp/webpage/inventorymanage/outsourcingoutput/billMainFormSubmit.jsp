	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/outsourcingoutput/outsourcingOutput/submitList"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="billMain" action="${ctx}/outsourcingoutput/outsourcingOutput/submit" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
<%-- 						<form:select path="billFlag" class="form-control required" disabled="true">
 --%>							<input value="新增" readOnly="true"     class="form-control required"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<sys:gridselect-modify targetId="wared" targetField="wareName"  disabled="disabled"
				...
				<input id="subFlag" style="display:none;"/>
				 <div class="form-group">
					...
					<div class="col-sm-10">
						...
						<form:input disabled="disabled" placeHolder="点击获取经办人" onclick="Test()" readOnly="true"  id="billPersonId"  value="${billMain.billPerson.no}" path="billPerson.no"
							    cssClass="form-control required"/>
					</div>
				</div> 
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<sys:gridselect-modify disabled="disabled" targetId="used" targetField="useDesc"
		...
		<div class="tabs-container">
			...
			<script type="text/template" id="billDetailTpl">//<!--
				<tr id="billDetailList{{idx}}" onmousemove="getSum(this.id)">
					...
					<td>
						<sys:gridselect-modify disabled="disabled" url="${ctx}/bin/bin/data"  urlParamName="wareId" urlParamId="wareNames" id="billDetailList{{idx}}_bin" name="billDetailList[{{idx}}].bin.id" value="{{row.bin.id}}" labelName="billDetailList{{idx}}.bin.binId" labelValue="{{row.bin.id}}"
					...
					<td>
						<sys:gridselect-modify disabled="disabled" url="${ctx}/location/location/data" urlParamName="binId" urlParamId="billDetailList{{idx}}_binNames" id="billDetailList{{idx}}_loc" name="billDetailList[{{idx}}].loc.id" value="{{row.loc.id}}" labelName="billDetailList{{idx}}.loc.locId" labelValue="{{row.loc.id}}"
					...
					<td style="display:none;">
						<input   id="billDetailList{{idx}}_itemQty2" name="billDetailList[{{idx}}].itemQty2" type="text" value="{{row.itemQty2}}"    class="form-control required"/>
					</td>
					<td style="display:none;">
