...
<head>
	...
	<%@include file="billMainListSubmit.js" %>
</head>
<body>
		...
		<div class="accordion-inner">
			...
			<div style="display:none;">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<sys:gridselect-modify targetId="wared" targetField="wareName" extraField="wareIdd:wareID"  url="${ctx}/warehouse/wareHouse/data" id="ware" name="ware.id" value="${billMain.ware.id}" labelName="ware.wareID" labelValue="${billMain.ware.wareID}"
			...
			<input style="display:none;" id="wareIdd" name="ware.wareID"  />
			 <div class="col-xs-12 col-sm-6 col-md-4">
			...
			<%--  <div class="col-xs-12 col-sm-6 col-md-4">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left">经办人编码：</label>
						<form:input placeHolder="点击获取经办人" onclick="Test()" readOnly="true"  id="billPersonId"  value="${billMain.billPerson.id}" path="billPerson.no"
				...
				<form:input path="billPerson.id" style="display:none;"  id="billPerson" name="billPerson.no" value="${billMain.billPerson.no}" labelName="billPerson.no" labelValue="${billMain.billPerson.no}"
							    cssClass="form-control required"/>
				 <div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left">经办人名字：</label>
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<sys:gridselect-modify  labelField="user.no" targetId="wareEmpname" targetField="empName"  url="${ctx}/employee/employee/data" id="wareEmp" name="wareEmp.id" value="${billMain.wareEmp.id}" labelName="wareEmp.user.no" labelValue="${billMain.wareEmp.user.no}"
					...
					<input style="display:none;" id="wareEmpd" name="wareEmp.user.no" value=""/>
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<sys:gridselect-modify extraField="useIdd:useId" targetId="used" targetField="useDesc" url="${ctx}/use/use/data" id="invuse" name="invuse.id" value="${billMain.invuse.id}" labelName="invuse.useId" labelValue="${billMain.invuse.useId}"
			...
			<!-- id还有问题 -->
					...
					<label class="label-item single-overflow pull-left" title="物料代码：">物料代码：</label>
						<sys:gridselect-again
							...
							extraField="itemNamed:item.name;itemSpec:item.specModel;itemcode:item.code" 
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="单据来源：">单据来源：</label>
				<form:select path="billSource"  class="form-control m-b">
					<form:option value="" label="全部"/>
					<form:option value="L" label="自动生成"/>
	...
	<div id="toolbar">
			<%-- <shiro:hasPermission name="billmain:billMain:add">
				<a id="add" class="btn btn-primary" href="${ctx}/outsourcingoutput/outsourcingOutput/form" title="单据"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission> --%>
