...
<head>
    ...
    <%@include file="orderAnalyseList.js"%>
</head>
<body>
    <div class="wrapper warpper-content">
        <div class="panel panel-primary">
            <div class="panel-body">
                ...
                <div class="accordion-group">
                    <div id="collapseTwo" class="accordion-body collapse">
                        <form:form id="searchForm" modelAttribute="orderAnalyse" class="form form-horizontal well clearfix">
            ...
            <!--表格-->
            <table id="orderAnalyseTable" data-toolbar="#toolbar"></table>
        </div>
        </div>
    </div>
