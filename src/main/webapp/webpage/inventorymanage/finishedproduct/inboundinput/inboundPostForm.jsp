            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="panelButton" href="${ctx}/inboundinput/inboundInput?type=Post"><i class="ti-angle-left"></i> 返回</a>
                    </h3>
                </div>
                <div class="panel-body">
                    <form:form id="inputForm" modelAttribute="billMain" action="${ctx}/inboundinput/inboundInput/save?type=Post" method="post" class="form-horizontal">
                        <form:hidden path="id"/>
				...
				<tr id="billDetailCodeList{{idx}}">
					...
					<td>
						<input id="billDetailCodeList{{idx}}_itemBarcode" readOnly="readOnly" onchange="getCode(this,{{idx}})" name="billDetailCodeList[{{idx}}].itemBarcode" type="text" value="{{row.itemBarcode}}"    class="form-control "/>
					</td>
					<td>
