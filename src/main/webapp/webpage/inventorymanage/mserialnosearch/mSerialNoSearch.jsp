...
<html>
<head>
	<title>产品机台码综合查询</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@include file="/webpage/include/treeview.jsp" %>
	<%@include file="mSerialNoSearch.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">产品机台码综合查询</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="mSerialNoSearch" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="物料二维码：">物料二维码：</label>
				<input id="objSn" name="objSn" htmlEscape="false"  class=" form-control required"/>
			</div>
				<div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left" title="机台码：">机台码：</label>
					<input id="mserialno" name="mserialno" htmlEscape="false"  class=" form-control required"/>
				</div>
		 <div class="col-xs-12 col-sm-6 col-md-4">
