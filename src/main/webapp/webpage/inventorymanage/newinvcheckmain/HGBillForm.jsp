            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="panelButton" href="${ctx}/newinvcheckmain/newinvCheckMain/HGSearch"><i class="ti-angle-left"></i> 返回</a>
                    </h3>
                </div>
                <div class="panel-body">
                    <form:form id="inputForm" modelAttribute="billMain" action="${ctx}/billmain/billMain/save"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <sys:gridselect url="${ctx}/billtype/billType/data" id="io" name="io.ioType"
                                                value="${billMain.io.ioType}" labelName="io.ioType"
                                                labelValue="${billMain.io.ioType}"
                                                title="选择单据类型" cssClass="form-control required" fieldLabels="单据类型|单据名称"
                                                fieldKeys="ioType|ioDesc" searchLabels="单据类型|单据名称"
                                                searchKeys="ioType|ioDesc"></sys:gridselect>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">经办人：</label>
                            <div class="col-sm-10">
                                <sys:userselect id="billPerson" name="billPerson.id" value="${billMain.billPerson.id}"
                                                labelName="billPerson.no" labelValue="${billMain.billPerson.no}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <sys:userselect id="billEmp" name="billEmp.no" value="${billMain.billEmp.no}"
                                                labelName="billEmp.no" labelValue="${billMain.billEmp.no}"
                                                cssClass="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
				...
				<tr id="billDetailList{{idx}}">
					...
					<td>
						<input id="billDetailList{{idx}}_serialNum" name="billDetailList[{{idx}}].serialNum" type="text" value="{{row.serialNum}}"    class="form-control"/>
					</td>
				...
				<tr id="billDetailCodeList{{idx}}">
					...
					<td>
						<input id="billDetailCodeList{{idx}}_serialNum" name="billDetailCodeList[{{idx}}].serialNum" type="text" value="{{row.serialNum}}"    class="form-control "/>
					</td>
					<td>
