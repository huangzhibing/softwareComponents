...
<head>
	...
	<%@include file="newinvCheckMainList.js" %>
</head>
<body>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="newinvcheckmain:newinvCheckMain:add">
				<a id="add" class="btn btn-primary" href="${ctx}/newinvcheckmain/newinvCheckMain/form" title="超期复验单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
