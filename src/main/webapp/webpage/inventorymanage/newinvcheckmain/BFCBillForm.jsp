	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/newinvcheckmain/newinvCheckMain/BFCSearch"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="billMain" action="${ctx}/newinvcheckmain/newinvCheck/BGuozhang" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<sys:gridselect url="${ctx}/billtype/billType/data" id="io" name="io.ioType" value="${billMain.io.ioType}" labelName="io.ioType" labelValue="${billMain.io.ioType}"
							 title="选择单据类型" cssClass="form-control" fieldLabels="单据类型|单据名称" fieldKeys="ioType|ioDesc" searchLabels="单据类型|单据名称" searchKeys="ioType|ioDesc" ></sys:gridselect>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="billEmpname" htmlEscape="false"    class="form-control"/>
					</div>
				</div>
			...
			<c:if test="${fns:hasPermission('billmain:billMain:edit') || isAdd}">
				...
				<div class="col-lg-6">
					<div class="form-group text-center">
						<div>
							<button onmousemove="judgePrice()" id="submitBtn"
									class="btn btn-primary btn-block btn-lg btn-parsley"
									data-loading-text="正在过账...">过 账
							</button>
						</div>
					</div>
				</div>
