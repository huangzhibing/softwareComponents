...
$(document).ready(function() {
	$('#myTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/shortagealarm/shortageAlarm/data",
			...
			,{
		        field: 'item.minStorage',
		        title: '最低储备',
		        sortable: true
		       
		    }
			,{
		        field: 'item.maxStorage',
		        title: '最高储备',
		        sortable: true
			...
			,{
		        ...
		        ,formatter:function(value, row , index){
		        	return row.nowQty<row.item.minStorage?row.item.minStorage-row.nowQty:0;
		         }
			...
			,{
		        ...
		        sortable: true
		        ,formatter:function(value, row , index){
		        	return row.nowQty>row.item.maxStorage?row.nowQty-row.item.maxStorage:0;
		         }
