...
<head>
	...
	<%@include file="outsourcingInputList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title">外购件入库单据列表</h3>
		</div>
			...
			<c:if test="${type eq 'Input'}">
				<div id="toolbar">
					<shiro:hasPermission name="billmain:billMain:add">
						<a id="add" class="btn btn-primary" href="${ctx}/outsourcinginput/outsourcingInput/form?type=Input" title="单据"><i
