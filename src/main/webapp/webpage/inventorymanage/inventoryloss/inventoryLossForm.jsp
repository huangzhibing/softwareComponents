                        ...
                        $.get("${ctx}/countdata/countMain/detail?id="+item.id, function(countMain){
							...
							if(countMain) {
                                ...
                                for (var i = 0; i < countMain.countDetailList.length; i++) {
                                    ...
                                    countMain.countDetailList[i].itemQty = countMain.countDetailList[i].itemQty - countMain.countDetailList[i].realQty
...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" modelAttribute="billMain" action="${ctx}/inventoryloss/inventoryLoss/save?type=${type}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<%--<c:if test="${fns:hasPermission('billmain:billMain:edit') || isAdd}">--%>
			<c:if test="${type eq 'input'}">
		        ...
		        <div class="col-lg-3">
		             <div class="form-group text-center">
						 <div>
							 <a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/inventoryloss/inventoryLoss?type=input"><i class="ti-angle-left"></i> 返 回</a>
						 </div>
		             </div>
		        </div>
			</c:if>
			<c:if test="${type eq 'query'}">
		        ...
		        <div class="col-lg-6">
		             <div class="form-group text-center">
						 <div>
							 <a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/inventoryloss/inventoryLoss?type=query"><i class="ti-angle-left"></i> 返 回</a>
		                 </div>
		             </div>
		        </div>
			</c:if>
			<c:if test="${type eq 'post'}">
				...
				<div class="col-lg-3">
		             <div class="form-group text-center">
						 ...
						 <div>
							 <a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/inventoryloss/inventoryLoss?type=post"><i class="ti-angle-left"></i> 返 回</a>
						 </div>
		             </div>
		        </div>
			</c:if>
