...
<head>
	...
	<%@include file="applyMainQueryList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购需求查询列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="applyMainQuery" class="form form-horizontal well clearfix">
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="applymainquery:applyMainQuery:view">
	...
	<!-- 表格 -->
	<table id="applyMainQueryTable"   data-toolbar="#toolbar"></table>

    <!-- context menu -->
    <ul id="context-menu" class="dropdown-menu">
    	<shiro:hasPermission name="applymainquery:applyMainQuery:edit">
        <li data-item="edit"><a>编辑</a></li>
        </shiro:hasPermission>
        <shiro:hasPermission name="applymainquery:applyMainQuery:del">
