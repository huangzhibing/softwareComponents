	...
	$('#contractMainTable').bootstrapTable({
		  ...
		  //请求方法
	       ...
	       //    detailFormatter: "detailFormatter",
               ...
               url: "${ctx}/contractmain/contractMainDetailView/data",
			...
			,{
		        ...
		        field: 'acceptedItemQty',
		        title: '已交数量',
		        sortable: true
		       
		    },{
		        field: 'unacceptedItemQty',
		        title: '未交数量'
		    //    sortable: true
  ...
  function detailFormatter(index, row) {
	...
	//点击打印按钮，触发事件
	   function print1(){	
	    ...
	    //添加物料的Id以及供应商的Id
	    bootSTParam.itemId=bootSTParam['item.id'];
	    bootSTParam.accountId=bootSTParam['account.id'];
	    console.log(bootSTParam);
	    $("#printIframe").attr("src","${ctx}/contractmain/contractMainDetailView/print?"+parseParams(bootSTParam));
