...
$(document).ready(function() {
	...
	$('#contractMainTable').bootstrapTable({
		  ...
		  //请求方法
	         ...
	         //  detailFormatter: "detailFormatter",
               ...
               url: "${ctx}/contractmain/contractMainPrint/data",
         ...
         //      contextMenu: '#context-menu',
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/contractmain/contractMainPrint/form?id=" + row.id;
			...
			,{
		       ...
		       /* ,formatter:function(value, row , index){
		        	return "<a href='${ctx}/contractmain/contractMainPrint/form?id="+row.id+"'>"+value+"</a>";
		         }
		       */
		    }
			,{
  ...
  function detail(){
	  ...
	  window.location = "${ctx}/contractmain/contractMainPrint/form?id=" + getIdSelections();
  }
        ...
        //    $("#printIframe")[0].contentWindow.print();
           ...
           jp.confirm('打印该采购订单吗？', function(){
              //  jp.loading();
               ...
               //写入打印标志
               $.ajax({
                   url:"${ctx}/contractmain/contractMainPrint/writeIsPrint?id="+getIdSelections(),
                   type: "GET",
                   cache: false,
                   dataType: "json",
