...
<head>
	...
	<%@include file="contractMainCloseList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购合同结案列表</h3>
	</div>
	...
	<div id="toolbar">
		...
		--%>	<shiro:hasPermission name="contractmainclose:contractMain:edit">
		...
		--%>	<shiro:hasPermission name="contractmainclose:contractMain:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/contractmain/contractMainClose/import" method="post" enctype="multipart/form-data"
