...
<head>
	...
	<%@include file="contractMainCheckList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购合同审核列表</h3>
	</div>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<%-- 	<shiro:hasPermission name="contractmainclose:contractMain:add">
		...
		--%>	<shiro:hasPermission name="contractmaincheck:contractMain:edit">
			    <button id="detail" class="btn btn-warning" onclick="detail()">
	            	 <i class="glyphicon glyphicon-folder-open"></i>  详情
	        	</button>
			</shiro:hasPermission>
		<%--	<shiro:hasPermission name="contractmainclose:contractMain:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
		--%>	<shiro:hasPermission name="contractmaincheck:contractMain:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/contractmain/contractMainCheck/import" method="post" enctype="multipart/form-data"
    ...
    <ul id="context-menu" class="dropdown-menu">
        ...
        <shiro:hasPermission name="contractmaincheck:contractMain:del">
