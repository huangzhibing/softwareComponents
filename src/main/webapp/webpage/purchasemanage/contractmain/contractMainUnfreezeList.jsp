...
<head>
	...
	<%@include file="contractMainUnfreezeList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购合同解冻列表</h3>
	</div>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<%--	<shiro:hasPermission name="contractmainunfreeze:contractMain:add">
				<a id="add" class="btn btn-primary" href="${ctx}/contractmain/contractMainUnfreeze/form" title="采购合同管理"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
		 --%><shiro:hasPermission name="contractmainunfreeze:contractMain:edit">
			   <button id="detail" class="btn btn-warning" onclick="detail()">
	            	 <i class="glyphicon glyphicon-folder-open"></i>  详情
	        	</button>
			</shiro:hasPermission>
		<%--	<shiro:hasPermission name="contractmainunfreze:contractMain:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
		--%>	<shiro:hasPermission name="contractmainunfreeze:contractMain:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/contractmain/contractMainUnfreeze/import" method="post" enctype="multipart/form-data"
    ...
    <ul id="context-menu" class="dropdown-menu">
        ...
        <shiro:hasPermission name="contractmainunfreeze:contractMain:del">
