...
<head>
	...
	<%@include file="contractMainDetailViewList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购订单明细列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="contractDetailView" class="form form-horizontal well clearfix">
	...
	<div id="toolbar">
				<!--  		
				<shiro:hasPermission name="contractmainviewing:contractMain:list">
					<button id="print" class="btn btn-success" disabled onclick="printPDF()">
