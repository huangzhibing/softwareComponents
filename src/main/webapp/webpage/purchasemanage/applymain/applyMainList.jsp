...
<head>
	...
	<%@include file="applyMainList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购需求列表</h3>
	</div>
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="applymain:applyMain:view">
	...
	<!-- 表格 -->
	<table id="applyMainTable"   data-toolbar="#toolbar"></table>
