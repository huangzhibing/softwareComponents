	...
	<div class="panel panel-primary">
		...
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<form:input path="applyDept" htmlEscape="false"  value="${fns:getUserOfficeName()}" readonly="true"  class="form-control required"/>
					</div>
				</div>
				...
				<tr id="applyDetailList{{idx}}">
					...
					<td width="70px">
						<div class='input-group form_datetime' id="applyDetailList{{idx}}_requestDate">
		                    <input type='text'  name="applyDetailList[{{idx}}].requestDate" class="form-control " readonly="true" value="{{row.requestDate}}"/>
		                    <span class="input-group-addon">
		                        <span class="glyphicon glyphicon-calendar"></span>
		                    </span>
		                </div>	
					...
					<td width="70px">
						<input id="applyDetailList{{idx}}_applyQty" name="applyDetailList[{{idx}}].applyQty" type="text" value="{{row.applyQty}}" readonly="true" onchange="applyQtyChange(this)"  class="form-control "/>
					</td>
