...
<head>
	...
	<%@include file="purPlanMainQueryList.js" %>
</head>
<body>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<%--<shiro:hasPermission name="purplan:purPlanMainQuery:add">
				<a id="add" class="btn btn-primary" href="${ctx}/purplan/purPlanMainQuery/form" title="采购计划"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>--%>
			<shiro:hasPermission name="purplan:purPlanMainQuery:list">
			    <button id="detail" class="btn btn-warning" onclick="detail()">
	            	 <i class="glyphicon glyphicon-folder-open"></i>  详情
	        	</button>
			</shiro:hasPermission>
			<%--<shiro:hasPermission name="purplan:purPlanMainQuery:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="purplan:purPlanMainQuery:del">
