	...
	<div class="panel panel-primary">
		...
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
							<div class='input-group form_datetime' id='applyDate'>
			                    <input type='text'  name="applyDate" class="form-control required" readonly="true"  value="<fmt:formatDate value="${applyMainAudit.applyDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
			                    <span class="input-group-addon">
			                        <span class="glyphicon glyphicon-calendar"></span>
			                    </span>
			                </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input id="applyType" name="applyType.applytypeid" htmlEscape="false" value="${applyMainAudit.applyType.applytypeid}" readonly="true" class="form-control required"/>
					</div>
		...
		<div class="tabs-container">
			...
			<script type="text/template" id="applyDetailAuditTpl">//<!--
				<tr id="applyDetailAuditList{{idx}}">
					...
					<td>
						<input id="applyDetailAuditList{{idx}}_item" name="applyDetailAuditList{{idx}}.item.code" type="text" value="{{row.item.code}}"  readonly="true"   class="form-control "/>
					</td>
					...
					<td>
						<input id="applyDetailAuditList{{idx}}_applySum" name="applyDetailAuditList[{{idx}}].applySum" type="text" value="{{row.applySum}}"  readonly="true"  class="form-control "/>
					</td>
					...
					<td>
						<input id="applyDetailAuditList{{idx}}_notes" name="applyDetailAuditList[{{idx}}].notes" type="text" value="{{row.notes}}"  readonly="true"  class="form-control "/>
					</td>
		        ...
		        <div class="col-lg-6">
		             <div class="form-group text-center">
		                 <div>
							...
							<c:if test="${applyMainAudit.act.taskDefKey!='purAppAud3'}">  
								<input id="btnSubmit" class="btn btn-primary" type="submit" value="审核通过" onclick="$('#flag').val('end')"/>&nbsp;
							</c:if>
