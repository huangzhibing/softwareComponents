		...
		<div class="tabs-container">
			...
			<script type="text/javascript">
				...
				<div id="tab-2" class="tab-pane fade">
					...
					<div class="table-responsive" style="max-height:500px">
					<table class="table table-striped table-bordered table-condensed" style="min-width:2250px">
						<thead>
						<tr>
							<th class="hide"></th>
							<th>工资单据号</th>
				...
				<tr id="personWageList{{idx}}">
					...
					<td>
						<input id="personWageList{{idx}}_orderId" name="personWageList[{{idx}}].orderId" type="text" value="{{row.orderId}}"    class="form-control "/>
					</td>
					...
					<script type="text/javascript">
                        ...
                        $(document).ready(function() {
                            ...
                            $("input[id^='personWageList']").attr('readOnly',true);
                            // $("input[id$='billNum']").attr('readOnly',false);
                            ...
                            var wPlan = (1*Qty)*(1*Unit); var wAssign = (1*Qty)*(1*wUnit);  var wPay = (1*Unit+1*wUnit)*(1*Qty);
							console.log(wAssign);
                            console.log(wPay);
