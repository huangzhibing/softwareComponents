...
$(document).ready(function() {
	$('#billMainTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/cosbillrecord/cosBillRecord/dataforCheck",
   			...
   			,{
   		        ...
   		        ,formatter:function(value, row , index){
   		        	return "<a href='${ctx}/cosbillrecord/cosBillRecord/form?id="+row.id+"'>"+value+"</a>";
   		         }
  ...
  function saveCosBillRecordAll(){
		jp.confirm('确认要稽核该单据记录吗？', function(){
			jp.loading();  	
			jp.get("${ctx}/cosbillrecord/cosBillRecord/saveCosBillRecordAll?ids=" + getIdSelections(), function(data){
       	  		if(data.success){
       	  			$('#billMainTable').bootstrapTable('refresh');
       	  			jp.success(data.msg);
       	  		}else{
