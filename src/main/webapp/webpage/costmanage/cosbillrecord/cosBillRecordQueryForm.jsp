	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/cosbillrecord/cosBillRecord/listQuery"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		...
		<sys:message content="${message}"/>	
	        ...
	        <div class="col-lg-6">
	             <div class="form-group text-center">
	                 ...
	                 <div class="col-lg-3">
	                     <a href= "${ctx}/cosbillrecord/cosBillRecord/listQuery" class="btn btn-primary btn-block btn-lg btn-parsley">返回</a>
	                 </div>
	             </div>
	        </div>
		</form:form>
