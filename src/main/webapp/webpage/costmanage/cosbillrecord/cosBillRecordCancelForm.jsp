...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
		    ...
		    //使用字典将对应键值转换
			$("#cosBillStatus").val(jp.getDictLabel(${fns:toJson(fns:getDictList('cosBillStatus'))}, $("#cosBillStatus").val(), "-"));
		});
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/cosbillrecord/cosBillRecord/listCancel"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="billMain" action="${ctx}/cosbillrecord/cosBillRecord/delCosBillRecord" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				<div class="form-group">
					...
					<div class="col-sm-3">
						<form:input path="cosBillStatus" htmlEscape="false"    class="form-control " readonly="true"/>
					</div>
				</div>
				<div class="form-group">
	        ...
	        <div class="col-lg-6">
	             <div class="form-group text-center">
	                 ...
	                 <div class="col-lg-3">
	                     <button class="btn btn-primary btn-lg btn-parsley" data-loading-text="正在撤销...">撤销</button>
	                     <a href= "${ctx}/cosbillrecord/cosBillRecord/listCancel" class="btn btn-primary btn-lg btn-parsley">返回</a>
	                 </div>
	             </div>
	        </div>
		</form:form>
