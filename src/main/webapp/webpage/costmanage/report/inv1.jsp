...
<head>
    ...
    <%@include file="inv1.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">原材料、包装材料本月发出表</h3>
        </div>
                    ...
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="invAccount" class="form form-horizontal well clearfix">
                            ...
                            <%--<div class="col-xs-12 col-sm-6 col-md-4">--%>
                                ...
                                <%--<sys:gridselect-item url="${ctx}/item/item/data" id="item" name="item.id" value="${invAccount.item.id}" labelName="item.code" labelValue="${invAccount.item.code}"--%>
                                                <%--title="选择物料编号" cssClass="form-control required" fieldLabels="物料编号|物料名称" fieldKeys="code|name" searchLabels="物料编号|物料名称" searchKeys="code|name"--%>
                                <%--extraField="itemCode:name"></sys:gridselect-item>--%>
                            <%--</div>--%>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <label class="label-item single-overflow pull-left" title="商品名称：">商品名称：</label>
                                <input name="item.name" htmlEscape="false" maxlength="2"  class=" form-control"/>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
