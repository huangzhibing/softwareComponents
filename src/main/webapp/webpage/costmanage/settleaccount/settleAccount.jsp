...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" modelAttribute="settleAccount" action="${ctx}/settleaccount/settleAccount/saveAccounting" method="post" class="form-horizontal">
		...
		<sys:message content="${message}"/>	
		        ...
		        <div class="col-lg-6">
		             <div class="form-group text-center">
		                 <div>
		                     <button class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在结账...">结账</button>
		                 </div>
		             </div>
		        </div>
		</form:form>
