...
<head>
	...
	<%@include file="needPayDetailList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">应付账款明细表</h3>
	</div>
		...
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="resourceImport" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="厂商名称：">厂商名称：</label>
				<form:input path="corName" htmlEscape="false" maxlength="10"  class=" form-control"/>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-4">
				 <div class="form-group">
					<label class="label-item single-overflow pull-left" title="入库日期：">&nbsp;收货日期：</label>
					<div class="col-xs-12">
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="订单号：">购货申请单号：</label>
				<form:input path="billNum" htmlEscape="false" maxlength="30"  class=" form-control"/>
			</div>
			<div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="材料名称：">品名：</label>
