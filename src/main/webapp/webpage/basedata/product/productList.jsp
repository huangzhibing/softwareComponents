...
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">产品维护列表</h3>
        </div>
        <div class="panel-body">
                    ...
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="product" class="form form-horizontal well clearfix">
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                ...
                                <sys:gridselect-new url="${ctx}/item/item/data" id="item"
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                ...
                                <form:input path="itemNameRu" htmlEscape="false" maxlength="50" class=" form-control"/>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <label class="label-item single-overflow pull-left" title="产品图号：">产品图号：</label>
            ...
            <div id="toolbar">
                <shiro:hasPermission name="product:product:add">
                    <a id="add" class="btn btn-primary" href="${ctx}/product/product/form" title="产品维护"><i
                ...
                <shiro:hasPermission name="product:product:import">
                    ...
                    <div id="importBox" class="hide">
                        <form id="importForm" action="${ctx}/product/product/import" method="post"
