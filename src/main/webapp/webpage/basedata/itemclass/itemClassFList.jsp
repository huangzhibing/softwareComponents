	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="物料类型编码：">物料类型编码：</label>
				<form:input path="classCode" htmlEscape="false" maxlength="50"  class=" form-control"/>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="父物料类名称：">父物料类编码：</label>
				<sys:treeselect-modify id="fatherClassCode" name="fatherClassCode.id" value="${itemClassF.fatherClassCode.id}" labelName="fatherClassCode.name" labelValue=" ${itemClassF.fatherClassCode.name}"
			  ...
			  <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<input id="Name" htmlEscape="false" maxlength="50"  class=" form-control" readOnly="readOnly"/>
			</div> 
			 <div class="col-xs-12 col-sm-6 col-md-4">
			  	<div class="form-group">
