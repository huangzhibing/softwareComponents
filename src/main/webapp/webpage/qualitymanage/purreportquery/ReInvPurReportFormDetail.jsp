...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" modelAttribute="purReportQuery" action="${ctx}/purreport/purReport/save" method="post" class="form-horizontal">
		...
		<sys:message content="${message}" />	
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="reinvCheckMain.billNum" htmlEscape="false"  readonly="true"   class="form-control required"/>
			...
			<script type="text/template" id="purReportRSnTpl">//<!--
				<tr id="purReportRSnList{{idx}}">
					...
					<td style="width: 100px;">
						...
						<input id="purReportRSnList{{idx}}_objectDef" name="purReportRSnList[{{idx}}].objectDef.id"  type="text" value="{{row.objectDef.id}}"  readonly="true"  class="form-control required"/>
