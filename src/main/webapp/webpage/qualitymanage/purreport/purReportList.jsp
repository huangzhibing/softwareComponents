...
<body>
	...
	<div id="toolbar">
			<shiro:hasPermission name="purreport:purReport:add">
				<a id="add" class="btn btn-primary" href="${ctx}/purreport/purReport/form" title="检验单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			...
			<shiro:hasPermission name="purreport:purReport:view">
