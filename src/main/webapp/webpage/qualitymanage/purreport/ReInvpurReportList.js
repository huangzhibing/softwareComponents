...
$(document).ready(function() {
	$('#purReportTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purreport/purReport/myDataReInv",
			...
			,{
		        ...
		        sortable: true,
		        formatter:function(value, row , index){
		        	return jp.getDictLabel(${fns:toJson(fns:getDictList('isAudit'))}, value, "-");
		        }
  ...
  function edit(){
	  window.location = "${ctx}/purreport/purReport/ReInvForm?id=" + getIdSelections();
  }
  function detail(){

	  window.location = "${ctx}/purreport/purReport/myDetailReInv?id=" + getIdSelections();
}
  
  function mydelete(){
	  window.location = "${ctx}/purreport/purReport/mydeleteReInv?id=" + getIdSelections();
  }
