...
$(document).ready(function() {
	$('#purReportTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purreport/purReport/myData",
  ...
  function edit(){
	  window.location = "${ctx}/purreport/purReport/form?id=" + getIdSelections();
  }
  function detail(){

	  window.location = "${ctx}/purreport/purReport/Mydetail?id=" + getIdSelections();
}
