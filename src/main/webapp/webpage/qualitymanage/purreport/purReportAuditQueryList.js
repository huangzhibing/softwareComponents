...
$(document).ready(function() {	
	$('#purReportTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purreport/purReportAuditQuery/dataAuditQuery",
...
/*		        ,formatter:function(value, row , index){
		        	return "<a href='${ctx}/purreport/purReportAudit?id="+row.id+"'>"+value+"</a>";
		         }*/
	  ...
	  $('#purReportTable').on('check.bs.table uncheck.bs.table load-success.bs.table ' +
            ...
            $('#showDetail').prop('disabled', $('#purReportTable').bootstrapTable('getSelections').length!=1);
        });
		...
		$("#btnImport").click(function(){
		  ...
		  $("#search").click("click", function() {// 绑定查询按扭
			    var jperson = $("#userName").val();
				$("#justifyPerson").val(jperson);
				var jposition = $("#roleName").val();
				$("#jpositionName").val(jposition);
				var officeName = $("#officeName").val();
				$("#jdeptName").val(officeName);
				console.log($("#justifyPerson").val());
				console.log($("#jpositionName").val());
				console.log($("#jdeptName").val());
  ...
  function showDetail(){
		 window.location = "${ctx}/purreport/purReportAuditQuery/AuditDetail?id=" + getIdSelections();  
  }
