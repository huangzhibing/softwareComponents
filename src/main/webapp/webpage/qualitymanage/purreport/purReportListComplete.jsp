...
<head>
	...
	<%@include file="purReportListComplete.js" %>
</head>
<body>
		...
		<div class="accordion-inner">
			 ...
			 <div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					...
					<form:select path="rndFul"  class="form-control m-b">
						...
						<form:options items="${fns:getDictList('checkType3')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:select path="checktName"  class="form-control m-b">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('checkNameS')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
			
			<div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="待检验：">待检验：</label>
				<form:select path="audit"  class="form-control m-b">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('anAidit')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
			
			 <div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left" title="检验对象序列号：">检验对象序列号：</label>
					<form:input path="scanCode" htmlEscape="false" maxlength="64"  class=" form-control"/>
			 </div>
		</div>	
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="purreport:purReport:addComp">
				<a id="add" class="btn btn-primary" href="${ctx}/purreport/purReport/myForm" title="检验单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="purreport:purReport:editComp">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="purreport:purReport:delComp">
				<button id="remove" class="btn btn-danger" disabled onclick="mydeleteCom()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			
			<shiro:hasPermission name="purreport:purReport:viewComp">
