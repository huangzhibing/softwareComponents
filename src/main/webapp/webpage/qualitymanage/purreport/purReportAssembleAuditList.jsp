...
<head>
	...
	<%@include file="purReportAssembleAuditList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">装配检验单审核列表</h3>
	</div>
			...
			<form:form id="searchForm" modelAttribute="purReport" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:select path="checktName"  class="form-control m-b">
					...
					<form:options items="${fns:getDictList('checkNameZ1')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
