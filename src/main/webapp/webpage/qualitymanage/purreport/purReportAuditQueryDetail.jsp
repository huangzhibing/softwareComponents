	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/purreport/purReportAuditQuery/listAuditQuery"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		...
		<sys:message content="${message}"/>	
				<div class="form-group">
					...
					<div class="col-md-3"> 
						<form:input path="invCheckMain.billnum" htmlEscape="false"    class="form-control required" readonly = "true"/>
					</div>
				</div>
				<div class="form-group">
				...
				<%-- <div class="form-group">
					...
					<div class="col-md-3"> 
	                    <input type='text'  name="checkDate" class="form-control "  value="<fmt:formatDate value="${purReport.checkDate}" pattern="yyyy-MM-dd"/>"
	                    readonly = "true"/>
					</div>
