	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/purreport/purReportSubmitQuery"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="purReport" action="${ctx}/purreport/purReportSubmitQuery/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				<div class="form-group">				   
					...
					<label class="col-sm-2 control-label">报检单编号：</label>	
					<div class="col-sm-3">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
					<%-- 	<form:input path="justifyDate" htmlEscape="false"    class="form-control "  readOnly="true"/>  --%>
					      <div class='form_datetime' id='checkDate'>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
					   ...
					   <%--  <input type="text" name="justifyDate" htmlEscape="false" class="form-control" readonly ="true"
		...
		--%>	<table class="table table-striped table-bordered table-condensed">
	 	...
	 	<c:if test="${fns:hasPermission('purreport:purReportSubmitQuery:list') || isAdd}">
				<div class="col-lg-3"></div>
		        <div class="col-lg-6">
		             <div class="form-group text-center">
		                 <div>
		                 	 <a href= "${ctx}/purreport/purReportSubmitQuery" class="btn btn-primary btn-block btn-lg btn-parsley">关闭</a>		                 
	 ...
	 <%--
	   <div class="col-lg-2"></div>
	      <div class="col-lg-3">
		             <div class="form-group text-center">
		                 <div>
		                      <input type ="submit" name="submit" class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在发送通知..." value="发送通知">
		                     <button class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在发送通知...">发送通知</button>		                
