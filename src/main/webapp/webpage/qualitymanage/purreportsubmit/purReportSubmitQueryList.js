 ...
 //  var url="${ctx}/purreport/purReportSubmit/data";
	...
	$('#purReportTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purreport/purReportSubmitQuery/data",
          //     url: "${ctx}/purreport/purReportSubmit/search",  
			...
			,{
		        ...
		        formatter:function(value, row , index){
		        	return "<a href='${ctx}/purreport/purReportSubmitQuery/form?id="+row.id+"'>"+value+"</a>";
		          }
  ...
  function edit(){
	  window.location = "${ctx}/purreport/purReportSubmitQuery/form?id=" + getIdSelections();
  }
