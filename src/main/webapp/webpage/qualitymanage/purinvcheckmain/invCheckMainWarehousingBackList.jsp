...
<head>
	...
	<%@include file="invCheckMainWarehousingBackList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">退货处理列表</h3>
	</div>
...
<%-- 			<div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="物料名称：">物料名称：</label>
				<form:input path="mainItemName" htmlEscape="false" maxlength="100"  class=" form-control"/>
			</div> --%>
			 <div class="col-xs-12 col-sm-6 col-md-4">
