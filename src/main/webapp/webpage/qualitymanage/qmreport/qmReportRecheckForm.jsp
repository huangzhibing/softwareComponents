...
<head>
	...
	<script type="text/javascript">
		...
		function openImportDialog(){
            ...
            jp.openDialog('检验单列表', '${ctx}/qmreport/qmReportRecheck/purlist','1200px', '800px', qmwindow);
		}
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/qmreport/qmReportRecheck"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<%--@elvariable id="qmReport" type="QmReport"--%>
		<form:form id="inputForm" modelAttribute="qmReport" action="${ctx}/qmreport/qmReportRecheck/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
	...
	<div class="control-group" style="margin-top: 26px">
		...
		<div class="col-lg-3"></div>
		        <div class="col-lg-6">
		             <div class="form-group text-center">
		                 <div>
		                     <a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/qmreport/qmReportRecheck" data-loading-text="正在返回...">返回</a>
		                 </div>
		             </div>
		        </div>
		</c:otherwise>
