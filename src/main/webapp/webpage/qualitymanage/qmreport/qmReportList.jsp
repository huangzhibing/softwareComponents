...
<%-- 			 <div class="col-xs-12 col-sm-4 col-md-2">
	...
	<div id="toolbar">
			<shiro:hasPermission name="qmreport:qmReport:add">
				<a id="add" class="btn btn-primary" href="${ctx}/qmreport/qmReport/form" title="质量问题"> <i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			...
			<%-- <shiro:hasPermission name="qmreport:qmReport:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/qmreport/qmReport/import" method="post" enctype="multipart/form-data"
