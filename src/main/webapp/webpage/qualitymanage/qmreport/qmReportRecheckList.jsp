...
<head>
	...
	<%@include file="qmReportRecheckList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购质量问题列表</h3>
	</div>
...
<%-- 			 <div class="col-xs-12 col-sm-4 col-md-2">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="qmreport:qmReportRecheck:add">
				<a id="add" class="btn btn-primary" href="${ctx}/qmreport/qmReportRecheck/form" title="质量问题"> <i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="qmreport:qmReportRecheck:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	 <i class="glyphicon glyphicon-edit"></i>  修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="qmreport:qmReportRecheck:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	 <i class="glyphicon glyphicon-remove"></i>  删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="qmreport:qmReportRecheck:list">
			    <button id="item_detail" class="btn btn-warning" onclick="itemDetail()">
	            	 <i class="glyphicon glyphicon-folder-open"></i>  详情
	        	</button>
			</shiro:hasPermission>
			<%-- <shiro:hasPermission name="qmreport:qmReportRecheck:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/qmreport/qmReportRecheck/import" method="post" enctype="multipart/form-data"
