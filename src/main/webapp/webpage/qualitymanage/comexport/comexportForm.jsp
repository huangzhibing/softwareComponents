	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/comexport/comexport"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="comexport" action="${ctx}/comexport/comexport/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">机台序列码：</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">良品：</label>
					<div class="col-sm-10">
						<form:input path="goodnum" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">不良品：</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">不良现象明细：</label>
					<div class="col-sm-10">
						<form:input path="baddetail" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
		<c:if test="${fns:hasPermission('comexport:comexport:edit') || isAdd}">
