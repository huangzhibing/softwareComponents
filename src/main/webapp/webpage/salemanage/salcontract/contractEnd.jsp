	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/salcontract/contract/contractEnd"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="contract" action="${ctx}/salcontract/contract/end" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:select path="contractStat" class="form-control required" disabled="true" >
							<form:option value="" label=""/>
							<form:options items="${fns:getDictList('contractStat')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
						</form:select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="input-group">
							<div class='input-group form_datetime' id='signDate'>
			                    <input type='text' readOnly="true"  name="signDate" class="form-control "  value="<fmt:formatDate value="${contract.signDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
					...
					<div class="col-sm-10">
						<p class="input-group">
							<div class='input-group form_datetime' id='inputDate'>
			                    <input disabled="disabled" type='text'  name="inputDate" class="form-control "  value="<fmt:formatDate value="${contract.inputDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
			                    <span class="input-group-addon">
			                        <span class="glyphicon glyphicon-calendar"></span>
			                    </span>
			                </div>						            
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<%-- <sys:userselect-modify disabled="disabled" targetId="endPsnNamed" id="endPerson" name="endPerson.id" value="${contract.endPerson.id}" labelName="endPerson.name" labelValue="${contract.endPerson.name}"
							    cssClass="form-control "/> --%>
						<form:input readOnly="true"  path="endPerson.no" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<p class="input-group">
							<div class='input-group form_datetime' id='endDate' disabled="disabled">
			                    <input type='text' readOnly="true"  name="endDate" class="form-control "  value="<fmt:formatDate value="${contract.endDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
			                    <span class="input-group-addon">
			                        <span class="glyphicon glyphicon-calendar"></span>
			                    </span>
			                </div>						            
		...
		<div class="tabs-container">
            <ul class="nav nav-tabs">
            	<li class="active"><a data-toggle="tab" href="#tab-2" aria-expanded="false">销售合同子表：</a>
                </li>
