	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/salcontract/contract/contractAudit"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		...
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input id="contractCode" readOnly="true" path="contractCode" htmlEscape="false"    class="form-control required"/>
					</div>
				</div>
				<%-- <div class="form-group">
		...
		<div class="tabs-container">
			...
			<script type="text/javascript">
		        ...
		        <div class="col-sm-2">
		                 	<a class="btn btn-primary btn-block btn-lg btn-parsley" onclick="pass()" href="#">审核通过</a>
		             
		        </div>
		        <div class="col-sm-1"></div>
		        <div class="col-sm-2">
		                 	<a class="btn btn-primary btn-block btn-lg btn-parsley" onclick="deny()" href="#">审核不通过</a>
		        </div>
		        <div class="col-sm-1"></div>
		        <div class="col-sm-2">
		                 	<a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/salcontract/contract/contractAudit">返回</a>
		        </div>	
				</div>
...
<script type="text/javascript">
	function pass(){
		...
		layer.confirm("确认通过吗？",['确认','取消'],function(){
			var url="${ctx}/salcontract/contract/contractPass";
			var parameter={id:id};
			$.post(url,parameter,function(data){
				if(data=="yes"){
					layer.msg("审核通过成功");
					window.location.href="${ctx}/salcontract/contract/contractAudit";
				}else{
					layer.msg("审核通过失败");
				}
			});
	...
	function deny(){
		...
		layer.open({
		  ...
		  ,content: '${ctx}/salcontract/contract/contractSuggestions?id='+id
		});  
	}
