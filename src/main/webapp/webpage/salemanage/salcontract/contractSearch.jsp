	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/salcontract/contract/contractSearch"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		...
		<c:if test="${fns:hasPermission('salcontract:contract:edit') || isAdd}">
		        ...
		        <div class="col-lg-6">
		             <div class="form-group text-center">
		                 <div>
		                 	<a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/salcontract/contract/contractSearch">返回</a>
		                 </div>
		             </div>
		        </div>
		</c:if>
