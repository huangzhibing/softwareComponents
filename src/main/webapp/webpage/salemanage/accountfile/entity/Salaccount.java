...
public class Salaccount extends DataEntity<Salaccount> {
	...
	private List<Contract> contractList = Lists.newArrayList();		// 子表列表
	private List<LinkMan> linkManList = Lists.newArrayList();		// 子表列表
	private List<PickBill> pickBillList = Lists.newArrayList();		// 子表列表
	...
	public List<PickBill> getPickBillList() {
		return pickBillList;
	}

	public void setPickBillList(List<PickBill> pickBillList) {
		this.pickBillList = pickBillList;
	}
}