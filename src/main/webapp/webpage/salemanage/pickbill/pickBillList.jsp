...
<body>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="pickbill:pickBill:add">
				<a id="add" class="btn btn-primary" href="${ctx}/act/task/form?procDefId=pickBill:1:3922ecdef3d747169261870e50b09548" title="单据"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="pickbill:pickBill:edit">
				<button id="edit" class="btn btn-success" onclick="printText()">
