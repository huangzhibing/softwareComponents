...
<%@ attribute name="labelNameForValue" type="java.lang.String" required="true" description="赋予给输入框值的Grid对象的属性"%>
    ...
    top.layer.open({
        ...
        yes: function(index, layero){
            ...
            for(var i=0; i<items.length; i++){
                ...
                console.log(item)
                ids.push(item.id);
                names.push(item${fn:substring(labelNameForValue, labelNameForValue.indexOf('.'), fn:length(labelNameForValue))})
