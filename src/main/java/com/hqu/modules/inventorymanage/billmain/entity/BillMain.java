 ...
 * @version 2018-04-16
 */
public class BillMain extends DataEntity<BillMain> {
	...
	private String isGood; //是否是良品

	private String itemName; //物料名称，用来查询子表
	/**
	 *@update zhangzheng
	 */
	 ...
	 * @zz 2018-8-31
	 */
	private String qItemCode;
	private String qItemName;
	private String qItemSpec;
	...
	public String getqItemCode() {
		return qItemCode;
	}

	public void setqItemCode(String qItemCode) {
		this.qItemCode = qItemCode;
	}
	...
	public String getqItemSpec() {
		return qItemSpec;
	}

	public void setqItemSpec(String qItemSpec) {
		this.qItemSpec = qItemSpec;
	}
