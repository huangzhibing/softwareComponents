 ...
 */
package com.hqu.modules.inventorymanage.inventoryloss.web;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/inventoryloss/inventoryLoss")
public class InventoryLossController extends BaseController {
	...
	public String list(String type,Model model) {
		...
		return "inventorymanage/inventoryloss/inventoryLossList";
	}
	...
	public Map<String, Object> data(BillMain billMain, HttpServletRequest request, HttpServletResponse response, Model model ,String type) {
        billMain.setIo(billTypeService.get("b617bd40536c4df3b0dee1eec1c94072"));
        if("post".equals(type)){
	...
	public String form(BillMain billMain, Model model,String type) {
		...
		if(StringUtils.isBlank(billMain.getId())){//如果ID是空为添加
            ...
            String newBillNum = billMainService.getMaxIdByTypeAndDate("PKO"+sdf.format(date));
            ...
            billMain.setBillNum("PKO" + sdf.format(date) + newBillNum);
...
//		    billMain.setWareEmp(employeeService.get(billMain.getWareEmp().getId()));
        ...
        model.addAttribute("type",type);
		return "inventorymanage/inventoryloss/inventoryLossForm";
	}
	...
	public String save(BillMain billMain, Model model, RedirectAttributes redirectAttributes,String type) throws Exception{
        if("post".equals(type)){
            ...
            if((boolean)resultMap.get("result")){
                ...
                return "redirect:"+Global.getAdminPath()+"/inventoryloss/inventoryLoss/?type="+type+"&repage";
            } else {
    ...
    public String importFile(MultipartFile file, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/inventoryloss/inventoryLoss/?repage";
    }
