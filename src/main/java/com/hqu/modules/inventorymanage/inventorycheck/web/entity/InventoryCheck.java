 ...
 */
package com.hqu.modules.inventorymanage.inventorycheck.web.entity;
 ...
 * @version 2018-04-22
 */
public class InventoryCheck extends DataEntity<InventoryCheck> {
	...
	private Double profitQty;	//盘盈数量
	private Double lossQty;		//盘亏数量
	private Double profitSum;	//盘盈金额
	private Double lossSum;		//盘亏金额

	public InventoryCheck(InvAccount invAccount){ //构造函数带入物料仓库等信息
		item = invAccount.getItem();
		realQty = invAccount.getRealQty();
	...
	public InventoryCheck(String id){
		super(id);
	}
