 ...
 */
package com.hqu.modules.inventorymanage.ppcsearch.entity;
 ...
 * @version 2018-10-31
 */
public class MSerialNoSearch extends DataEntity<MSerialNoSearch> {
	...
	private String reqid;	//内部订单号
	private String centercode;	//工作中心编号
	private String actualbdate;	//安规开始时间
	private String billNoDetail;	//入库单号

	public MSerialNoSearch() {
		super();
	}

	public MSerialNoSearch(String id){
		super(id);
	}
	...
	public String getActualbdate() {
		return actualbdate;
	}

	public void setActualbdate(String actualbdate) {
