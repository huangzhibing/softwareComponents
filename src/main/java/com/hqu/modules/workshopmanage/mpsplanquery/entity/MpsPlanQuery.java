 ...
 */
package com.hqu.modules.workshopmanage.mpsplanquery.entity;
 ...
 * @version 2018-09-04
 */
public class MpsPlanQuery extends DataEntity<MpsPlanQuery> {
	...
	private String makeName;//制定人名称
	
	public MpsPlanQuery() {
		super();
	}

	public MpsPlanQuery(String id){
		super(id);
	}
	...
	@ExcelField(title="产品编码", align=2, sort=7)
	...
	@ExcelField(title="产品名称", align=2, sort=8)
	...
	@ExcelField(title="来源标志", align=2, sort=12)
	...
	@ExcelField(title="销售订单号", align=2, sort=13)
	...
	@ExcelField(title="审核意见", align=2, sort=31)
