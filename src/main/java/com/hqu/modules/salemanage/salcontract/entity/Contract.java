...
public class Contract extends DataEntity<Contract> {
	...
	private SaleTaxRatio saleTaxRatio;
	...
	private Product prodCode;      //记录产品
	private Date deliveryDate;//交货日期
	
	
	private CtrItemsModel ctrItemsModel;
	private List<CtrFIle> ctrFIleList = Lists.newArrayList();		// 子表列表
	private List<CtrItem> ctrItemList = Lists.newArrayList();		// 子表列表
	...
	public CtrItemsModel getCtrItemsModel() {
		return ctrItemsModel;
	}

	public void setCtrItemsModel(CtrItemsModel ctrItemsModel) {
		this.ctrItemsModel = ctrItemsModel;
	}

	public SaleTaxRatio getSaleTaxRatio() {
		return saleTaxRatio;
	}

	public void setSaleTaxRatio(SaleTaxRatio saleTaxRatio) {
	...
	@ExcelField(title="客户编码", fieldType=Account.class, value="", align=2, sort=11)
	...
	public List<CtrFIle> getCtrFIleList() {
		return ctrFIleList;
	}

	public void setCtrFIleList(List<CtrFIle> ctrFIleList) {
		this.ctrFIleList = ctrFIleList;
	}
	public List<CtrItem> getCtrItemList() {
		return ctrItemList;
	}

	public void setCtrItemList(List<CtrItem> ctrItemList) {
		this.ctrItemList = ctrItemList;
	}
}