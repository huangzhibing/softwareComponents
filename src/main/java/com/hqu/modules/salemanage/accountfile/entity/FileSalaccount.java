 ...
 * @version 2018-05-16
 */
public class FileSalaccount extends DataEntity<FileSalaccount> {
	...
	private List<FileSalaccount> fileSalaccountList = Lists.newArrayList(); //子表列表
	private List<FileContract> fileContractList = Lists.newArrayList();		// 子表列表
	private List<FileLinkMan> fileLinkManList = Lists.newArrayList();		// 子表列表
	private List<FilePickBill> filePickBillList = Lists.newArrayList();		// 子表列表
	
	public FileSalaccount() {
		super();
	}

	public FileSalaccount(String id){
		super(id);
	}
	...
	public AreaDef getAreaDef() {
		return areaDef;
	}

	public void setAreaDef(AreaDef areaDef) {
	...
	public void setAccountType2(AccountType2 accountType2) {
	...
	public List<FileSalaccount> getFileSalaccountList() {
		return fileSalaccountList;
	}

	public void setFileSalaccountList(List<FileSalaccount> fileSalaccountList) {
		this.fileSalaccountList = fileSalaccountList;
	}
	...
	public void setFileContractList(List<FileContract> fileContractList) {
		this.fileContractList = fileContractList;
	}
	public List<FileLinkMan> getFileLinkManList() {
		return fileLinkManList;
	}

	public void setFileLinkManList(List<FileLinkMan> fileLinkManList) {
		this.fileLinkManList = fileLinkManList;
	}
	public List<FilePickBill> getFilePickBillList() {
		return filePickBillList;
	}

	public void setFilePickBillList(List<FilePickBill> filePickBillList) {
		this.filePickBillList = filePickBillList;
	}
}