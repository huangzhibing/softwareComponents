 ...
 * @version 2018-05-16
 */
public class FilePickBill extends DataEntity<FilePickBill> {
	...
	private FileSalaccount account;		// 收货客户编码 父类
	...
	public FilePickBill(String id){
		super(id);
	}

	public FilePickBill(FileSalaccount account){
