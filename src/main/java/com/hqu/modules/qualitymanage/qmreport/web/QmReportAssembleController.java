 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/qmreport/qmReportAssemble")
public class QmReportAssembleController extends BaseController {
	 ...
	 * 质量问题列表页面
	 */
	@RequiresPermissions("qmreport:qmReport:list")
	@RequestMapping(value = {"list", ""})
	public String list() {
		return "qualitymanage/qmreport/qmReportAssembleList";
	}
	...
	public String purlist(@ModelAttribute PurReport pur) {
		//CacheUtils.remove("dictMap");//清除dictMap（字典类型）缓存。调BUG专用（框架存在的BUG）。
		return "qualitymanage/qmreport/purReportAssembleSelectList";
	}
	...
	public Map<String, Object> dataAssemble(QmReport qmReport, HttpServletRequest request, HttpServletResponse response, Model model) {
		//qmReport.setCreateBy(UserUtils.getUser());
		qmReport.setState("编辑中");
		qmReport.setQmType("装配");
	 ...
	 * 查看，增加，编辑装配质量问题表单页面
	 */
	@RequiresPermissions(value={"qmreport:qmReport:view","qmreport:qmReport:add","qmreport:qmReport:edit"},logical=Logical.OR)
	...
	public String form(QmReport qmReport, Model model,@RequestParam(required=false) String justSee) {
		...
		return "qualitymanage/qmreport/qmReportAssembleForm";
	}
	 ...
	 * 保存装配质量问题
	 */
	@RequiresPermissions(value={"qmreport:qmReport:add","qmreport:qmReport:edit"},logical=Logical.OR)
	...
	public String save(QmReport qmReport, Model model, RedirectAttributes redirectAttributes) throws Exception{
		...
		return "redirect:"+Global.getAdminPath()+"/qmreport/qmReportAssemble/?repage";
	}
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("qmreport:qmReport:del")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("qmreport:qmReport:export")
