 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/qmreport/qmReportRecheck")
public class QmReportRecheckController extends BaseController {
	 ...
	 * 质量问题列表页面
	 */
	@RequiresPermissions("qmreport:qmReportRecheck:list")
	@RequestMapping(value = {"list", ""})
	public String list() {
		return "qualitymanage/qmreport/qmReportRecheckList";
	}
...
/*		if("F".equals(type)) {
		...
		return "qualitymanage/qmreport/purReportRecheckSelectList";
	}
	 ...
	 * 查看，增加，编辑采购质量问题表单页面
	 */
	@RequiresPermissions(value={"qmreport:qmReportRecheck:view","qmreport:qmReportRecheck:add","qmreport:qmReportRecheck:edit"},logical=Logical.OR)
	...
	public String form(QmReport qmReport, Model model,@RequestParam(required=false) String justSee) {
		...
		return "qualitymanage/qmreport/qmReportRecheckForm";
	}

	/**
	 * 保存采购质量问题
	 */
	@RequiresPermissions(value={"qmreport:qmReportRecheck:add","qmreport:qmReportRecheck:edit"},logical=Logical.OR)
	...
	public String save(QmReport qmReport, Model model, RedirectAttributes redirectAttributes) throws Exception{
		...
		return "redirect:"+Global.getAdminPath()+"/qmreport/qmReportRecheck/?repage";
	}
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("qmreport:qmReportRecheck:del")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("qmreport:qmReportRecheck:export")
	 ...
	 */
	@RequiresPermissions("qmreport:qmReportRecheck:import")
