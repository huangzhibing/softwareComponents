 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/qmreport/qmReport")
public class QmReportController extends BaseController {
	...
	public String list() {
		return "qualitymanage/qmreport/qmReportList";
	}
...
/*		if("F".equals(type)) {
	...
	public String form(QmReport qmReport, Model model,@RequestParam(required=false) String justSee) {
		...
		return "qualitymanage/qmreport/qmReportForm";
	}
	...
	public String save(QmReport qmReport, Model model, RedirectAttributes redirectAttributes) throws Exception{
		...
		return "redirect:"+Global.getAdminPath()+"/qmreport/qmReport/?repage";
	}
	 ...
	 */
	@RequiresPermissions("qmreport:qmReport:import")
