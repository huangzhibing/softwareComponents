 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/qmreportquery/qmReportQuery")
public class QmReportQueryController extends BaseController {
	...
	/**
	 * 质量问题报告列表数据(车间查看：整机检测类型问题 )
	 */
	@RequiresPermissions("sfc:qmReportQuery:list")
	@RequestMapping(value = "sfcList")
	public String sfcList() {
		return "qualitymanage/qmreportquery/qmReportSfcQueryList";
	}
	 ...
	 * 质量问题报告列表页面
	 */
	@RequiresPermissions("qmreportquery:qmReportQuery:list")
	@RequestMapping(value = {"list", ""})
	public String list() {
		return "qualitymanage/qmreportquery/qmReportQueryList";
	}
	 ...
	 * 查看，增加，编辑质量问题报告表单页面
	 */
	@RequiresPermissions(value={"qmreportquery:qmReportQuery:view","qmreportquery:qmReportQuery:add","qmreportquery:qmReportQuery:edit"},logical=Logical.OR)
	...
	public String form(QmReportQuery qmReportQuery, Model model) {
		...
		return "qualitymanage/qmreportquery/qmReportQueryForm";
	}

	/**
	 * 保存质量问题报告
	 */
	@RequiresPermissions(value={"qmreportquery:qmReportQuery:add","qmreportquery:qmReportQuery:edit"},logical=Logical.OR)
	...
	public String save(QmReportQuery qmReportQuery, Model model, RedirectAttributes redirectAttributes) throws Exception{
		...
		return "redirect:"+Global.getAdminPath()+"/qmreportquery/qmReportQuery/?repage";
	}
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("qmreportquery:qmReportQuery:del")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("qmreportquery:qmReportQuery:export")
	 ...
	 */
	@RequiresPermissions("qmreportquery:qmReportQuery:import")
