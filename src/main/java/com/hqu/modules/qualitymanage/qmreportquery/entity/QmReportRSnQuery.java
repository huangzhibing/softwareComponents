 ...
 * @version 2018-04-17
 */
public class QmReportRSnQuery extends DataEntity<QmReportRSnQuery> {
	
	private static final long serialVersionUID = 1L;
	private String sn;		// 序号
	private QmReportQuery qmReportId;		// 问题处理报告单编号 父类
	...
	private String purReportRSnId;		// 对应检验单中检验对象的id
	...
	public QmReportRSnQuery() {
		super();
	}

	public QmReportRSnQuery(String id){
		super(id);
	}

	public QmReportRSnQuery(QmReportQuery qmReportId){
	...
	public QmReportQuery getQmReportId() {
		return qmReportId;
	}

	public void setQmReportId(QmReportQuery qmReportId) {
		this.qmReportId = qmReportId;
	}
	...
	@ExcelField(title="对应检验单中检验对象的id", align=2, sort=21)
