...
import com.hqu.modules.qualitymanage.purreport.mapper.PurReportSubmitMapper;
...
public class PurReportSubmitService extends CrudService<PurReportSubmitMapper, PurReport> {

	@Autowired
	private PurReportRSnSubmitMapper purReportRSnMapper;
	@Autowired
	private PurReportSubmitMapper purReportSubmitMapper;
	...
	public List<PurReport> findListNew(PurReport purReport) {
		return purReportSubmitMapper.findListNew(purReport);
	}
