...
public class SfcReportSubmitService extends CrudService<SfcReportSubmitMapper, PurReport> {

	@Autowired
	private PurReportRSnSubmitMapper purReportRSnMapper;
	@Autowired
	private SfcReportSubmitMapper sfcReportSubmitMapper;
	...
	public List<PurReport> findListNew(PurReport purReport) {
		return sfcReportSubmitMapper.findListNew(purReport);
	}
