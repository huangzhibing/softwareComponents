...
/**
 * IQC来料检验报告外观检查缺陷描述Entity
 * @author syc
 * @version 2018-08-18
 */
public class Purreportnewsn extends DataEntity<Purreportnewsn> {
	
	private static final long serialVersionUID = 1L;
	private PurReportNew reportId;		// 报告单主键 父类
	private MatterType matterType;		// 产品外观缺陷描述
	private Integer crNum;		// 致命缺陷产品数量
	private Integer majNum;		// 严重缺陷产品数量
	private Integer minNum;		// 轻微缺陷产品数量
	private Integer sum;		// 不良品数量
	
	public Purreportnewsn() {
		super();
	}

	public Purreportnewsn(String id){
		super(id);
	}

	public Purreportnewsn(PurReportNew reportId){
	...
	@NotNull(message="产品外观缺陷描述不能为空")
	@ExcelField(title="产品外观缺陷描述", fieldType=MatterType.class, value="matterType.mattername", align=2, sort=8)
