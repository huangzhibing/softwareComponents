...
/**
 * IQC来料检验报告产品尺寸缺陷描述Entity
 * @author syc
 * @version 2018-08-18
 */
public class Purreportsizedetail extends DataEntity<Purreportsizedetail> {
	
	private static final long serialVersionUID = 1L;
	private PurReportNew reportId;		// 报告单主键 父类
	private MatterType matterType;		// 产品尺寸缺陷描述
	private Integer crNum;		// 致命缺陷产品数量
	private Integer majNum;		// 严重缺陷产品数量
	private Integer minNum;		// 轻微缺陷产品数量
	private Integer sum;		// 不良品数量
	
	public Purreportsizedetail() {
		super();
	}

	public Purreportsizedetail(String id){
		super(id);
	}

	public Purreportsizedetail(PurReportNew reportId){
	...
	@NotNull(message="产品尺寸缺陷描述不能为空")
	@ExcelField(title="产品尺寸缺陷描述", fieldType=MatterType.class, value="matterType.mattername", align=2, sort=8)
