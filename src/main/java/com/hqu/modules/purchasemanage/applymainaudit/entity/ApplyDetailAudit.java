 ...
 * @version 2018-05-08
 */
public class ApplyDetailAudit extends DataEntity<ApplyDetailAudit> {
	
	private static final long serialVersionUID = 1L;
	private ApplyMainAudit applyMainQuery;		// 需求单号 父类
	...
	public ApplyDetailAudit() {
		super();
	}

	public ApplyDetailAudit(String id){
		super(id);
	}

	public ApplyDetailAudit(ApplyMainAudit applyMainQuery){
		this.applyMainQuery = applyMainQuery;
	}

	public ApplyMainAudit getApplyMainQuery() {
		return applyMainQuery;
	}

	public void setApplyMainQuery(ApplyMainAudit applyMainQuery) {
		this.applyMainQuery = applyMainQuery;
	}
