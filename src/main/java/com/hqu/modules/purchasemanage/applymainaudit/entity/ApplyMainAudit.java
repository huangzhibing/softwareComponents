 ...
 */
package com.hqu.modules.purchasemanage.applymainaudit.entity;
 ...
 * @version 2018-05-08
 */
public class ApplyMainAudit extends ActEntity<ApplyMainAudit> {
	...
	private List<ApplyDetailAudit> applyDetailAuditList = Lists.newArrayList();		// 子表列表
	
	public ApplyMainAudit() {
		super();
	}

	public ApplyMainAudit(String id){
		super(id);
	}
	...
	public List<ApplyDetailAudit> getApplyDetailAuditList() {
		return applyDetailAuditList;
	}

	public void setApplyDetailAuditList(List<ApplyDetailAudit> applyDetailAuditList) {
		this.applyDetailAuditList = applyDetailAuditList;
	}
