 ...
 */
@MyBatisMapper
public interface ContractDetailWarningMapper extends BaseMapper<ContractDetailWarning> {
	public List<ContractDetailWarning> findListNotArriveAll(ContractDetailWarning contractDetailWarning);
}