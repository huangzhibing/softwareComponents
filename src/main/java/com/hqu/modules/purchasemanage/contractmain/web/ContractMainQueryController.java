 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/contractmain/contractMainQuery")
public class ContractMainQueryController extends BaseController {
	 ...
	 * 采购合同管理列表页面
	 */
	@RequiresPermissions("contractmainquery:contractMain:list")
	@RequestMapping(value = {"list", ""})
	public String list() {
		return "purchasemanage/contractmain/contractMainQueryList";
	}
	 ...
	 * 查看，增加，编辑采购合同管理表单页面
	 */
	@RequiresPermissions(value={"contractmainquery:contractMain:view","contractmainclose:contractMain:add","contractmainclose:contractMain:edit"},logical=Logical.OR)
	...
	public String form(ContractMain contractMain, Model model) {
		...
		return "purchasemanage/contractmain/contractMainQueryForm";
	}

	/**
	 * 提交采购合同管理
	 */
	@RequiresPermissions(value={"contractmainquery:contractMain:add","contractmainclose:contractMain:edit"},logical=Logical.OR)
	...
	public String submit(ContractMain contractMain, Model model, RedirectAttributes redirectAttributes) throws Exception{
		...
		return "redirect:"+Global.getAdminPath()+"/contractmain/contractMainQuery/?repage";
	}
	...
	*/
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("contractmainquery:contractMain:del")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("contractmainuquery:contractMain:del")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("contractmainquery:contractMain:export")
	 ...
	 * 导入Excel数据
	 */
	@RequiresPermissions("contractmainquery:contractMain:import")
	 ...
	 * 获取采购合同子表的物料信息
	 */
	@RequiresPermissions(value={"contractmainquery:contractMain:view","contractmainquery:contractMain:add","contractmainquery:contractMain:edit"},logical=Logical.OR)
