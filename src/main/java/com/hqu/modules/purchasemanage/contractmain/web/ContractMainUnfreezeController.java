...
import com.hqu.modules.purchasemanage.contractmain.service.ContractMainUnfreezeService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/contractmain/contractMainUnfreeze")
public class ContractMainUnfreezeController extends BaseController {

	@Autowired
	private ContractMainUnfreezeService contractMainService;
	 ...
	 * 采购合同管理列表页面
	 */
	@RequiresPermissions("contractmainunfreeze:contractMain:list")
	@RequestMapping(value = {"list", ""})
	public String list() {
		return "purchasemanage/contractmain/contractMainUnfreezeList";
	}
	 ...
	 * 查看，增加，编辑采购合同管理表单页面
	 */
	@RequiresPermissions(value={"contractmainunfreeze:contractMain:view","contractmainfreeze:contractMain:add","contractmainfreeze:contractMain:edit"},logical=Logical.OR)
	...
	public String form(ContractMain contractMain, Model model) {
		if(contractMain.getAct().isFinishTask()&&!StringUtils.isBlank(contractMain.getId())){
			...
			return "purchasemanage/contractmain/contractMainUnfreezeForm";
		}
	}
	 ...
	 * 提交采购合同管理
	 */
	@RequiresPermissions(value={"contractmainunfreeze:contractMain:add","contractmainunfreeze:contractMain:edit"},logical=Logical.OR)
	...
	//	contractMain.setContrState("C");
		...
		return "redirect:"+Global.getAdminPath()+"/contractmain/contractMainUnfreeze/?repage";
	*/	
		...
		try {
			...
			//新增或编辑表单保存
			contractMainService.save(contractMain);//提交
			addMessage(redirectAttributes, "合同解冻成功");
		}catch (Exception e) {
	...
	*/
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("contractmainunfreeze:contractMain:del")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("contractmainunfreeze:contractMain:export")
