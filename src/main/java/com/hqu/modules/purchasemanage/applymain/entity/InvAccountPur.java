...
/**com.hqu.modules.inventorymanage.invaccount.entity.InvAccount
 * 库存账Entity
 * @author M1ngz
 * @version 2018-04-22
 */
public class InvAccountPur extends DataEntity<InvAccountPur> {
	...
	public InvAccountPur() {
		super();
	}

	public InvAccountPur(String id){
		super(id);
	}
