 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/purplan/purPlanMainClose")
public class PurPlanMainCloseController extends BaseController {
	 ...
	 * 采购计划列表页面
	 */
	@RequiresPermissions("purplan:purPlanMainClose:list")
	@RequestMapping(value = {"list", ""})
	public String list() {
		return "purchasemanage/purplan/purPlanMainCloseList";
	}
	 ...
	 */
	@ResponseBody
	@RequiresPermissions(value= {"purplan:purPlanMainClose:add","purplan:purPlanMainClose:edit",})
	 ...
	 * 查看，增加，编辑采购计划表单页面
	 */
	@RequiresPermissions(value={"purplan:purPlanMainClose:view","purplan:purPlanMainClose:add","purplan:purPlanMainClose:edit"},logical=Logical.OR)
	...
	public String form(PurPlanMain purPlanMain, Model model,@RequestParam(required=false) String detail) {
		...
		return "purchasemanage/purplan/purPlanMainCloseForm";
	}

	/**
	 * 保存采购计划
	 */
	@RequiresPermissions(value={"purplan:purPlanMainClose:add","purplan:purPlanMainClose:edit"},logical=Logical.OR)
	...
	public String save(PurPlanMain purPlanMain, Model model, RedirectAttributes redirectAttributes ) throws Exception{
		...
		return "redirect:"+Global.getAdminPath()+"/purplan/purPlanMainClose/?repage";
	}
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("purplan:purPlanMainClose:del")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("purplan:purPlanMainClose:export")
	 ...
	 */
	@RequiresPermissions("purplan:purPlanMainClose:import")
