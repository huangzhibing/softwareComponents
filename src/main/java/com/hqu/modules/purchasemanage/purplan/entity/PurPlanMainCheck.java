 ...
 * @version 2018-05-03
 */
public class PurPlanMainCheck extends DataEntity<PurPlanMainCheck> {
	...
	private List<PurPlanDetailCheck> purPlanDetailCheckList = Lists.newArrayList();		// 子表列表
	...
	public PurPlanMainCheck() {
		super();
	}

	public PurPlanMainCheck(String id){
		super(id);
	}
	...
	public List<PurPlanDetailCheck> getPurPlanDetailCheckList() {
		return purPlanDetailCheckList;
	}

	public void setPurPlanDetailCheckList(List<PurPlanDetailCheck> purPlanDetailCheckList) {
		this.purPlanDetailCheckList = purPlanDetailCheckList;
	}
}