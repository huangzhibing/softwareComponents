...
import com.hqu.modules.purchasemanage.purplan.service.PurPlanMainQueryService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/purplan/purPlanMainQuery")
public class PurPlanMainQueryController extends BaseController {
	...
	@Autowired
	private PurPlanMainQueryService purPlanMainQueryService;
	...
	public PurPlanMain get(@RequestParam(required=false) String id) {
		...
		if (StringUtils.isNotBlank(id)){
			...
			entity=purPlanMainQueryService.get(id);
		}
		if (entity == null){
	 ...
	 * 采购计划列表页面
	 */
	@RequiresPermissions("purplan:purPlanMainQuery:list")
	@RequestMapping(value = {"list", ""})
	public String list() {
		return "purchasemanage/purplan/purPlanMainQueryList";
	}
	 ...
	 */
	@ResponseBody
	@RequiresPermissions(value= {"purplan:purPlanMainQuery:add","purplan:purPlanMainQuery:edit",})
	 ...
	 * 查看，增加，编辑采购计划表单页面
	 */
	@RequiresPermissions(value={"purplan:purPlanMainQuery:view","purplan:purPlanMainQuery:add","purplan:purPlanMainQuery:edit"},logical=Logical.OR)
	 ...
	 * 保存采购计划
	 */
	@RequiresPermissions(value={"purplan:purPlanMainQuery:add","purplan:purPlanMainQuery:edit"},logical=Logical.OR)
	...
	public String save(PurPlanMain purPlanMain, Model model, RedirectAttributes redirectAttributes ) throws Exception{
		...
		return "redirect:"+Global.getAdminPath()+"/purplan/purPlanMainQuery/?repage";
	}
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("purplan:purPlanMainQuery:del")
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("purplan:purPlanMainQuery:export")
	 ...
	 */
	@RequiresPermissions("purplan:purPlanMainQuery:import")
