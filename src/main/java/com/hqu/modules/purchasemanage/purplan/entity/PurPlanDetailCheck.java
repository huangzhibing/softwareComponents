 ...
 * @version 2018-05-03
 */
public class PurPlanDetailCheck extends DataEntity<PurPlanDetailCheck> {
	
	private static final long serialVersionUID = 1L;
	private PurPlanMainCheck billNum;		// 单据编号 父类
	...
	public PurPlanDetailCheck() {
		super();
	}

	public PurPlanDetailCheck(String id){
		super(id);
	}

	public PurPlanDetailCheck(PurPlanMainCheck billNum){
		this.billNum = billNum;
	}

	public PurPlanMainCheck getBillNum() {
		return billNum;
	}

	public void setBillNum(PurPlanMainCheck billNum) {
		this.billNum = billNum;
	}
	...
	@ExcelField(title="物料编号", fieldType=Item.class, value="itemCode.code", align=2, sort=9)
	...
	@ExcelField(title="采购数量", align=2, sort=38)
