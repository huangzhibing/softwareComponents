 ...
 * @version 2018-05-01
 */
public class PurLinkMan extends DataEntity<PurLinkMan> {
	...
	private String linkRemarks;		// 备注
	private Puraccount Puraccount;		// 主表ID 父类
	
	public PurLinkMan() {
		super();
	}

	public PurLinkMan(String id){
		super(id);
	}

	public PurLinkMan(Puraccount Puraccount){
