 ...
 * @version 2018-05-01
 */
public class Puraccount extends DataEntity<Puraccount> {
    ...
    private String accountFile;    //供应商附件
    
    private List<PurContractMain> purContractMainList = Lists.newArrayList();        // 子表列表
    private List<PinvCheckMain> pinvCheckMainList = Lists.newArrayList();        // 子表列表
    private List<PurLinkMan> purLinkManList = Lists.newArrayList();        // 子表列表

    public Puraccount() {
        super();
    }

    public Puraccount(String id) {
        super(id);
    }
    ...
    public void setAreaDef(AreaDef areaCode) {
    ...
    */
    ...
    public List<PurContractMain> getPurContractMainList() {
        return purContractMainList;
    }

    public void setPurContractMainList(List<PurContractMain> purContractMainList) {
        this.purContractMainList = purContractMainList;
    }

    public List<PinvCheckMain> getPinvCheckMainList() {
        return pinvCheckMainList;
    }

    public void setPinvCheckMainList(List<PinvCheckMain> pinvCheckMainList) {
        this.pinvCheckMainList = pinvCheckMainList;
    }

    public List<PurLinkMan> getPurLinkManList() {
        return purLinkManList;
    }

    public void setPurLinkManList(List<PurLinkMan> purLinkManList) {
        this.purLinkManList = purLinkManList;
    }
}