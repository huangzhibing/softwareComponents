 ...
 */
package com.hqu.modules.costmanage.personwage.entity;
 ...
 * @version 2018-09-01
 */
public class PersonWage extends DataEntity<PersonWage> {
...
//	private User personCode;		// 人员代码
	private Routing routing;		//工艺代码
	private Team team;			//班组代码
	private Product itemCode;		// 产品代码
	private Double itemUnit;		// 单位计件工资
	private Double itemQty;		// 工作量
	...
	private String billNum;		// 工资单据号
	/**
	 * update by @zhangzheng
	 */
	private String processBillNo; //作业计划号(对应加工路线中的相同字段)
