...
//               url:"${ctx}/purreport/purReportAuditQuery/dataAuditQuery",
               url: "${ctx}/purreport/purReportAudit/dataAssembleAudit",
...
/*	  $("#search").click("click", function() {// 绑定查询按扭
  ...
  function showDetail(){
		 window.location = "${ctx}/purreport/purReportAudit/AssembleAuditDetail?id=" + getIdSelections();  
  }
  ...
  function detailFormatter(index, row) {
	  ...
	  $.get("${ctx}/purreport/purReportAudit/detail?id="+row.id, function(purReport){
