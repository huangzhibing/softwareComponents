	...
	<div class="panel panel-primary">
		...
		<sys:message content="${message}"/>	
				...
				<div class="form-group" style="display:none">
					<label class="col-sm-2 control-label"><font color="red">*</font>ID：</label>
					<div class="col-sm-10">
						<form:input path="id" htmlEscape="false"  readonly="true"   class="form-control required"/>
					</div>
				</div>
			...
			<script type="text/javascript">
				...
				function myDelete(){
					jp.confirm('确认要删除该检验单记录吗？', function(){
						var id = $("#id").val();
						window.location = "${ctx}/purreport/purReport/mydeleteEleCom?id=" + id;
