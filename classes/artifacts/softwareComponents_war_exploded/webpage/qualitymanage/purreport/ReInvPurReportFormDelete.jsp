	...
	<div class="panel panel-primary">
		...
		<form:hidden path="userDeptCode" value="${fns:getUserOfficeCode()}"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="checktName" value="${purReport.reinvCheckMain.billNum}" htmlEscape="false"  readonly="true" class="form-control "/>
			...
			<script type="text/javascript">
				...
				function myDelete(){
					jp.confirm('确认要删除该检验单记录吗？', function(){
						var id = $("#id").val();
						window.location = "${ctx}/purreport/purReport/mydeleteEleReInv?id=" + id;
