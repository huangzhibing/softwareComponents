...
$(document).ready(function() {
	$('#purReportTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purreport/purReport/myDataAsse",
  ...
  function edit(){
	  window.location = "${ctx}/purreport/purReport/formAsse?id=" + getIdSelections();
  }
  function detail(){

	  window.location = "${ctx}/purreport/purReport/MydetailAsse?id=" + getIdSelections();
}
  
  function mydelete(){
	  window.location = "${ctx}/purreport/purReport/mydeleteAsse?id=" + getIdSelections();
  }
