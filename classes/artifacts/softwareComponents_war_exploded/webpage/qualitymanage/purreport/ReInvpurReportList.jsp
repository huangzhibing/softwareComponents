...
<head>
	...
	<%@include file="ReInvpurReportList.js" %>
</head>
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="purReport" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="超期复验单编号：">超期复验：</label>
									
					<sys:gridselect url="${ctx}/newinvcheckmain/newinvCheckMain/checkdata" id="reinvCheckMain" name="reinvCheckMain.id" value="${purReport.reinvCheckMain.id}" labelName="reinvCheckMain.billNum" labelValue="${purReport.reinvCheckMain.billNum}"
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:select path="checktName"  class="form-control m-b">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('checkName')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
	...
	<div id="toolbar">
			<shiro:hasPermission name="purreport:purReport:add">
				<a id="add" class="btn btn-primary" href="${ctx}/purreport/purReport/ReInvForm" title="检验单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
