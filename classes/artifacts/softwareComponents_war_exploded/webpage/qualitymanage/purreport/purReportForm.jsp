...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<!--  					<form:option value="" label=""/>  -->
				...
				<div class="form-group" >
					...
					<form:select path="cpositionName" class="form-control "  onchange="getChange()">
							<form:option value="IQC" label="IQC"/>
			...
			<script type="text/template" id="purReportRSnTpl">//<!--
				<tr id="purReportRSnList{{idx}}">
					...
					<td style="width: 150px;">
						<sys:gridselect url="${ctx}/mattertype/matterType/data" id="purReportRSnList{{idx}}_matterType" name="purReportRSnList[{{idx}}].matterType.id" value="{{row.matterType.id}}" labelName="purReportRSnList{{idx}}.matterType.mattername" labelValue="{{row.matterType.mattername}}"
							 title="选择问题类型名称"
							isMultiSelected="true" cssClass="form-control  required" fieldLabels="问题类型编码|问题类型名称" fieldKeys="mattercode|mattername" searchLabels="问题类型编码|问题类型名称" searchKeys="mattercode|mattername" ></sys:gridselect>
					</td>
		        ...
		        <div class="col-lg-2">
		             <div class="form-group text-center">
		                 <div>
		                	 ...
		                	 <input type="submit" class="btn btn-primary btn-block btn-lg btn-parsley" value="保存" onclick="changeFlag1()"> &nbsp;
		        ...
		        <div class="col-lg-2">
		             <div class="form-group text-center">
		                 <div>
							...
							<input type="submit" class="btn btn-primary btn-block btn-lg btn-parsley" value="完成并提交" onclick="changeFlag()"> &nbsp;
		                 </div>
		             </div>
		        </div>
		        <div class="col-lg-1"></div>
		...
		function myclose(){
			//alert("close");
			window.location ="${ctx}/purreport/purReport/list";
		...
		function sub(){
			...
			var newUrl = "${ctx}/purreport/purReport/subsave";    //设置新提交地址
