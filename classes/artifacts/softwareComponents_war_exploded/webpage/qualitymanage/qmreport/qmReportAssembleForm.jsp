...
<head>
	...
	<script type="text/javascript">
		...
		function openImportDialog(){
			jp.openDialog('检验单列表', '${ctx}/qmreport/qmReportAssemble/purlist','1200px', '800px', qmwindow);
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/qmreport/qmReportAssemble"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
			<%--@elvariable id="qmReport" type="com.hqu.modules.qualitymanage.qmreport.entity.QmReport"--%>
		<form:form id="inputForm" modelAttribute="qmReport" action="${ctx}/qmreport/qmReportAssemble/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
