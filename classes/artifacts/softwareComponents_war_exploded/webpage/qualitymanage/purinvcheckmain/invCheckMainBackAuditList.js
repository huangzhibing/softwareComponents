...
$(document).ready(function() {
	$('#invCheckMainTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purinvcheckmain/invCheckMain/dataBackAudit",
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/purinvcheckmain/invCheckMain/formBackAuditDetail?id=" + row.id;
                   } else if($el.data("item") == "delete"){
                        jp.confirm('确认要删除该采购退货管理记录吗？', function(){
                       	jp.loading();
			...
			,{
		       ...
		       formatter:function(value, row , index){
		        	return "<a href='${ctx}/purinvcheckmain/invCheckMain/formBackAuditDetail?id="+row.id+"'>"+value+"</a>";
		         }
