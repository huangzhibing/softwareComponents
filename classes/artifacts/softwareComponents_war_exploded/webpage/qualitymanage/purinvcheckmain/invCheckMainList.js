...
$(document).ready(function() {
	$('#invCheckMainTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purinvcheckmain/invCheckMain/data",
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/purinvcheckmain/invCheckMain/formDetail?id=" + row.id;
			...
			,{
		       ...
		       formatter:function(value, row , index){
		        	return "<a href='${ctx}/purinvcheckmain/invCheckMain/formDetail?id="+row.id+"'>"+value+"</a>";
		         }
