...
$(document).ready(function() {
	$('#invCheckMainTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purinvcheckmain/invCheckMain/dataBackNew",
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/purinvcheckmain/invCheckMain/formBackDetail?id=" + row.id;
			...
			,{
		       ...
		       formatter:function(value, row , index){
		        	return "<a href='${ctx}/purinvcheckmain/invCheckMain/formBackNewDetail?id="+row.id+"'>"+value+"</a>";
		         }
