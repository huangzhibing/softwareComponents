...
<head>
	...
	<%@include file="invCheckMainCreatList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购到货生成列表</h3>
	</div>
	...
	<div id="toolbar">
			<shiro:hasPermission name="purinvcheckmain:invCheckMain:add">
				<a id="add" class="btn btn-primary" href="${ctx}/purinvcheckmain/invCheckMain/formCreat" title="采购到货"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
