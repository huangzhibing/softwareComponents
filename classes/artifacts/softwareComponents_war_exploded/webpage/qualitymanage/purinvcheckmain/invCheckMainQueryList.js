...
$(document).ready(function() {
	$('#invCheckMainTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purinvcheckmain/invCheckMain/dataQuery",
			...
			,{
		       ...
		       formatter:function(value, row , index){
		        	return "<a href='${ctx}/purinvcheckmain/invCheckMain/Queryform?id="+row.id+"'>"+value+"</a>";
		         }
	 ...
	 $("#reset").click("click", function() {// 绑定查询按扭
		  ...
		  $('#invCheckMainTable').bootstrapTable('refresh');
				...
				$('#beginArriveDate').datetimepicker({
					 format: "YYYY-MM-DD"
				});
				$('#endArriveDate').datetimepicker({
					 format: "YYYY-MM-DD"
				});
