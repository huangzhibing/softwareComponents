...
$(document).ready(function() {
	$('#invCheckMainTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purinvcheckmain/invCheckMain/dataBackQuery",
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/purinvcheckmain/invCheckMain/formBackQueryDetail?id=" + row.id;
			...
			,{
		       ...
		       formatter:function(value, row , index){
		        	return "<a href='${ctx}/purinvcheckmain/invCheckMain/formBackQueryDetail?id="+row.id+"'>"+value+"</a>";
		         }
