...
<head>
	...
	<%@include file="invReportSubmitList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">超期复验单发送列表</h3>
	</div>
			...
			<div class="row">
				...
				<%--	<form:input path="checktName" htmlEscape="false" maxlength="64"  class=" form-control"/>
				 --%>	<form:select path="checktName"  class="form-control m-b" disabled="true">
						<form:option value="cqfy" label="超期复验"/>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			   <shiro:hasPermission name="purreport:invReportSubmit:list">			
