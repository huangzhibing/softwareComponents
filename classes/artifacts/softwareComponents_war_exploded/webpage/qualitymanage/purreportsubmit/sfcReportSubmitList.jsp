...
<head>
	...
	<%@include file="sfcReportSubmitList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">整机检验单发送列表</h3>
	</div>
		...
		<div class="accordion-inner">
			...
			<div class="row">
				...
				<%--	<form:input path="checktName" htmlEscape="false" maxlength="64"  class=" form-control"/>
				 --%>	<form:select path="checktName"  class="form-control m-b" disabled="true">
						<form:option value="zj" label="整机"/>
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					...
					<form:select path="checkResult"  class="form-control m-b" disabled="true">
						<form:option value="hg" label="合格"/>
			...
			<div class="row">	
				<div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left" title="未发送/已发送：">发送状态：</label>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			   <shiro:hasPermission name="purreport:sfcReportSubmit:list">			
			    <button id="view" class="btn btn-warning" disabled onclick="view()">
