	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/purreport/invReportSubmit"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="purReport" action="${ctx}/purreport/invReportSubmit/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				<div class="form-group">				   
					...
					<label class="col-sm-2 control-label">超期复验单编号：</label>	
					<div class="col-sm-3">
					 	<form:input path="reinvCheckMain.billNum" htmlEscape="false"    class="form-control" readOnly="true"/>					
					</div>
				</div>
				<div class="form-group">
	...
	<%-- 	<c:if test="${fns:hasPermission('purreport:purReportSubmit:view') || isAdd}">
	 ...
	 --%> <div class="col-lg-2"></div>
		        ...
		        <c:if test="${purReport.sendState=='1'}">   
			        ...
			        <div class="form-group text-center">
			                 <div>
		                         <a href= "${ctx}/purreport/invReportSubmit" class="btn btn-primary btn-block btn-lg btn-parsley">关闭</a>
			                 </div>
			             </div>
			        </div>
		        </c:if>
