 ...
 //  var url="${ctx}/purreport/purReportSubmit/data";
	...
	$('#purReportTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/purreport/purReportSubmit/data",
          //     url: "${ctx}/purreport/purReportSubmit/search",  
			...
			,{
		        ...
		        formatter:function(value, row , index){
		        	return "<a href='${ctx}/purreport/purReportSubmit/form?id="+row.id+"'>"+value+"</a>";
		          }
			...
			,{
		        ...
		        sortable: true,
		     /*   formatter:function(value, row , index){
			        //	return "<a href='${ctx}/purreport/purReport/form?id="+row.id+"'>"+value+"</a>";
		        	return "<span>"+"</span>"
			        }
			        */
		    }
  ...
  function edit(){
	  window.location = "${ctx}/purreport/purReportSubmit/form?id=" + getIdSelections();
  }
  ...
  function detailFormatter(index, row) {
	  ...
	  $.get("${ctx}/purreport/purReportSubmit/detail?id="+row.id, function(purReport){
