	...
	<div class="panel panel-primary">
		...
		<sys:message content="${message}"/>	
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="auditpCode" htmlEscape="false"  readonly="true"  class="form-control required"/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="auditItemCode" htmlEscape="false"  readonly="true"  class="form-control required"/>
					</div>
				</div>
				<div class="form-group">
