...
<form:form id="inputForm" modelAttribute="contractMain" action="#" method="post" class="form-horizontal">
 ...
 <tr height=30 style='height:22.5pt'>
  ...
  position:absolute;z-index:1;margin-left:625px;margin-top:3px;width:123px;
  ...
  <table cellpadding=0 cellspacing=0>
   <tr>
    <td colspan=11 height=30 class=xl180 width=762 style='height:22.5pt;
 ...
 <tr height=34 style='height:25.5pt'>
  <td colspan=10 height=34 class=xl182 style='height:25.5pt'>领 料 单</td>
 </tr>
 <tr height=29 style='mso-height-source:userset;height:21.95pt'>
  ...
  width:77pt'>单据号:</td>
  <td colspan=3 class=xl165 width=240 style='width:181pt'>${contractMain.materialOrder}</td>
  <td colspan=2 height=29 class=xl176 width=102 style='height:21.95pt;width:77pt'>出入库单号：</td>
  <td colspan=4 class=xl165 width=318 style='width:239pt'>${contractMain.invBillNo}</td>
 </tr>
 <tr height=29 style='mso-height-source:userset;height:21.95pt'>
  <td colspan=2 height=29 class=xl176 width=102 style='height:21.95pt;
  width:77pt'>领料类型:</td>
  <td colspan=3 class=xl165 width=240 style='width:181pt'><c:if test="${contractMain.billType=='R'}">退料 (${contractMain.qualityFlag})</c:if><c:if test="${contractMain.billType=='G'}">领料</c:if></td>
  <td colspan=2 class=xl183 width=102 style='width:77pt'>单据类型：</td>
  <td colspan=4 class=xl174 width=318 style='width:239pt'><c:if test="${contractMain.receiveType=='C'}">系统生成</c:if><c:if test="${contractMain.receiveType=='M'}">手工录入</c:if></td>
 </tr>
 <tr height=29 style='mso-height-source:userset;height:21.95pt'>
  <td colspan=2 height=29 class=xl176 width=102 style='height:21.95pt;
  width:77pt'>部门名称:</td>
  <td colspan=3 class=xl165 width=240 style='width:181pt'>${contractMain.shopName}</td>
  <td colspan=2 class=xl171 width=102 style='width:77pt'>库房名称：</td>
  <td colspan=4 class=xl175 width=318 style='width:239pt'>${contractMain.wareName}</td>
 </tr>
 <tr height=29 style='mso-height-source:userset;height:21.95pt'>
  <td colspan=2 height=29 class=xl176 width=102 style='height:21.95pt;
  width:77pt'>核算期:<span style='mso-spacerun:yes'>&nbsp;</span></td>
  <td colspan=3 class=xl165 width=240 style='width:181pt'>${contractMain.periodId}</td>
  <td colspan=2 class=xl176 width=102 style='width:77pt'>工作中心：</td>
  <td colspan=4 class=xl174 width=318 style='width:239pt'>${contractMain.operName}</td>
 </tr>
 
 </table>  
 
 <table  id="contractDetailList"  border=1 cellpadding=0 cellspacing=0 width=737 style='border-collapse:collapse;width:100%'>
   <%--<thead style="display:table-header-group">--%>
	 ...
	 <%--</tr>--%>
	 <tr class=xl130 height=32 style='mso-height-source:userset;height:24.0pt'>
	  <td colspan=1 height=32 class=xl164 width=52 style='height:24.0pt;border-top:none;
	  width:39pt'>序号</td>
	  <td colspan=2 class=xl164 width=104 style='border-left:none;width:79pt'>物料代码</td>
	  <td colspan=3 class=xl164 width=98 style='border-top:none;border-left:none;width:74pt'>物料名称</td>
	  <td colspan=2 class=xl164 width=88 style='border-top:none;border-left:none;width:66pt'>物料规格</td>
	  <td colspan=2 class=xl153 width=41 style='border-top:none;border-left:none;width:31pt'>领用数量</td>
	 </tr>
...
<%-- <tr height=19 style='height:14.25pt'>
 ...
 <tr height=19 style='height:114.25pt'>
 ...
 <tr height=44 style='mso-height-source:userset;height:33.0pt'>
  <td height=44 class=xl140 colspan=3 style='height:33.0pt;mso-ignore:colspan'>领料人：${contractMain.respName}</td>
  <td class=xl140></td>
  <td class=xl141></td>
  <td class=xl141></td>
  <td class=xl140 colspan=3 style='mso-ignore:colspan'>库管员：${contractMain.wareEmpname}</td>
  <td class=xl145></td>
  <td></td>
 </tr>
 <tr height=44 style='mso-height-source:userset;height:33.0pt'>
 ...
 <tr height=44 style='mso-height-source:userset;height:33.0pt'>
  <td height=44 class=xl142 colspan=2 style='height:33.0pt;mso-ignore:colspan'>制单日期：<fmt:formatDate value="${contractMain.editDate}" pattern="yyyy/MM/dd"/></td>
  <td class=xl143></td>
  <td class=xl140></td>
  <td class=xl140></td>
  <td class=xl141></td>
  <td class=xl142>领料日期：<fmt:formatDate value="${contractMain.operDate}" pattern="yyyy/MM/dd"/></td>
  <td class=xl144></td>
  <td class=xl140></td>
  <td class=xl140></td>
  <td></td>
...
<script type="text/template" id="contractDetailTpl">			
 <tr height=37 style='mso-height-source:userset;height:28.35pt'>
  <td colspan=1 class=xl148 width=52 style='height:28.35pt;border-top:none;width:39pt'>{{row.sequenceId}}</td>
  <td colspan=2 class=xl178 width=104 style='border-right:.5pt solid black;border-left:none;width:79pt'>{{row.materialId}}</td>
  <td colspan=3 class=xl155 width=98 style='border-left:none;width:74pt'>{{row.materialName}}</td>
  <td colspan=2 class=xl155 width=88 style='border-left:none;width:66pt'>{{row.materialSpec}}</td>
  <td colspan=2 class=xl155 width=88 style='border-left:none;width:31pt'>{{row.requireNum}}</td>
  ...
  <%--<td class=xl161 width=77 style='border-left:none;width:58pt'>{{row.massRequire}}</td>--%>
    ...
    <script type="text/javascript">
		...
		$(document).ready(function() {
			var data = ${fns:toJson(contractMain.sfcMaterialOrderDetailList)};
			console.log(data);
