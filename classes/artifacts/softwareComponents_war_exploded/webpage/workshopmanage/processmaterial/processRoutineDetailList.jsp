...
<head>
	...
	<%@include file="processRoutineDetailList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">车间物料安装单列表</h3>
	</div>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<%--<shiro:hasPermission name="processmaterial:processRoutineDetail:add">
				<a id="add" class="btn btn-primary" href="${ctx}/processmaterial/processRoutineDetail/form" title="车间物料安装单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="processmaterial:processRoutineDetail:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="processmaterial:processRoutineDetail:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="processmaterial:processRoutineDetail:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/processmaterial/processRoutineDetail/import" method="post" enctype="multipart/form-data"
