...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" modelAttribute="personWage" action="${ctx}/personwage/personWage/proof?flag=${flag}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="wageUnit" htmlEscape="false" readonly="true" onchange="getAssignWage()" class="form-control "/>
					</div>
				</div>
				<div class="form-group">
		...
		<c:if test="${fns:hasPermission('personwage:personWage:edit') || isAdd}">
				...
				<div class="col-lg-6">
					<div class="form-group text-center">
						<div>
							<button class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在提交...">制 单</button>
						</div>
					</div>
				</div>
        </c:if>
