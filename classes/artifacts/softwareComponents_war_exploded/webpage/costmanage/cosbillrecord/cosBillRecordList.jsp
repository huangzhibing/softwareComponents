...
<head>
	...
	<%@include file="cosBillRecordList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">材料单据稽核列表</h3>
	</div>
	...
	<div id="toolbar">
	        	...
	        	<a class="accordion-toggle btn btn-default" data-toggle="collapse" data-parent="#accordion2" onclick="saveCosBillRecordAll()">
