	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/cosbillrecord/cosBillRecord/listMaking"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="billMain" action="${ctx}/cosbillrecord/cosBillRecord/saveBillMaking" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
	        ...
	        <div class="col-lg-6">
	             <div class="form-group text-center">
	                 ...
	                 <div class="col-lg-3">
	                     <button class="btn btn-primary btn-lg btn-parsley" data-loading-text="正在制单...">制单</button>
	                     <a href= "${ctx}/cosbillrecord/cosBillRecord/listMaking" class="btn btn-primary btn-lg btn-parsley">返回</a>
	                 </div>
	             </div>
	        </div>
		</form:form>
