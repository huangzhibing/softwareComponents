		...
		<div class="tabs-container">
			...
			<script type="text/template" id="realAccountDetailTpl">//<!--
				<tr id="realAccountDetailList{{idx}}">
					...
					<td>
						<input id="realAccountDetailList{{idx}}_itemName" name="realAccountDetailList[{{idx}}].itemName"  readOnly="true"  type="text" value="{{row.itemName}}"    class="form-control required"/>
					</td>
