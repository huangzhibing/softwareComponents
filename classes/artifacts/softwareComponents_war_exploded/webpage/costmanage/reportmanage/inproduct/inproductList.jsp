...
<head>
	...
	<%@include file="inproductList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">产成品入库表</h3>
	</div>
		...
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="resourceImport" class="form form-horizontal well clearfix">
				<div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left" title="车间：">车间：</label>
					<form:input path="deptName" htmlEscape="false" maxlength="10"  class=" form-control"/>
				</div>

				<div class="col-xs-12 col-sm-6 col-md-4">
					<div class="form-group">
						<label class="label-item single-overflow pull-left" title="出库日期：">&nbsp;入库日期：</label>
						<div class="col-xs-12">
				...
				<div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left" title="工位号:">工位号：</label>
					<form:input path="workPosname" htmlEscape="false" maxlength="10"  class=" form-control"/>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4">
					<label class="label-item single-overflow pull-left" title="订单号:">订单号：</label>
					<form:input path="orderNum" htmlEscape="false" maxlength="10"  class=" form-control"/>
				</div>
