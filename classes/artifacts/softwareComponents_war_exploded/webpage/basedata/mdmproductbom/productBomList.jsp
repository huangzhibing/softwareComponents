...
<head>
	...
	<%@include file="productBomTree.js" %>
</head>
<body>
							...
							<div class="accordion-inner">
								<form:form id="searchForm" modelAttribute="productBom"
									...
									<div class="col-xs-12 col-sm-6 col-md-4">
										...
										<sys:gridselect-modify targetId="fatherItemName" targetField="name" url="${ctx}/item/item/data" id="fatherItem" name="fatherItem.id"
