	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/adtdetail/detail"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="detail" action="${ctx}/adtdetail/detail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
					...
					<div class="col-sm-10">
						<p class="input-group">
							<div class='input-group form_datetime' id='justifyDate'>
			                    <input type='text'  name="justifyDate" class="form-control"  value="<fmt:formatDate value="${detail.justifyDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>下一个审核人代码：</label>
					<div class="col-sm-10">
						<form:input path="njpersonCode" htmlEscape="false"    class="form-control required"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>下一个审核人：</label>
					<div class="col-sm-10">
						<form:input path="nJustifyPerson" htmlEscape="false"    class="form-control required"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>下一个审核部门编码：</label>
					<div class="col-sm-10">
						<form:input path="njdeptCode" htmlEscape="false"    class="form-control required"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>下一个审核部门名称：</label>
					<div class="col-sm-10">
						<form:input path="njdeptName" htmlEscape="false"    class="form-control required"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>下一个审核岗位编码：</label>
					<div class="col-sm-10">
						<form:input path="njpositionCode" htmlEscape="false"    class="form-control required"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">下一个审核岗位名称：</label>
					<div class="col-sm-10">
						<form:input path="njpositionName" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
		...
		<c:if test="${fns:hasPermission('adtdetail:detail:edit') || isAdd}">
