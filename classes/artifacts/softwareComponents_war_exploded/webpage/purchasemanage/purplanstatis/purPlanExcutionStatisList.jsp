...
<head>
	...
	<%@include file="purPlanExcutionStatisList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购计划执行情况列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="purPlanExcutionStatis" class="form form-horizontal well clearfix">
	...
	<div id="toolbar">
		...
		<button id="print" class="btn btn-success"  onclick="print()">
			...
			<%--<shiro:hasPermission name="purplanstatis:purPlanExcutionStatis:add">
				<a id="add" class="btn btn-primary" href="${ctx}/purplanstatis/purPlanExcutionStatis/form" title="采购计划执行情况表"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="purplanstatis:purPlanExcutionStatis:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="purplanstatis:purPlanExcutionStatis:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="purplanstatis:purPlanExcutionStatis:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/purplanstatis/purPlanExcutionStatis/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="purPlanExcutionStatisTable"   data-toolbar="#toolbar"></table>
