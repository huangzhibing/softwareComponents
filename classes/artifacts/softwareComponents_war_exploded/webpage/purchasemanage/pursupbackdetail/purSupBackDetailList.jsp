...
<html>
<head>
	<title>供应商退货明细管理</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@include file="/webpage/include/treeview.jsp" %>
	<%@include file="purSupBackDetailList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">供应商退货明细列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="purSupBackDetail" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				 <div class="form-group">
					<label class="label-item single-overflow pull-left" title="退货日期：">&nbsp;退货日期：</label>
					<div class="col-xs-12">
						   <div class="col-xs-12 col-sm-5">
					        	  <div class='input-group date' id='beginBackDate' style="left: -10px;" >
					                   <input type='text'  name="beginBackDate" class="form-control"  />
					        ...
					        <div class="col-xs-12 col-sm-5">
					          	<div class='input-group date' id='endBackDate' style="left: -10px;" >
					                   <input type='text'  name="endBackDate" class="form-control" />
					                   <span class="input-group-addon">
					                       <span class="glyphicon glyphicon-calendar"></span>
					                   </span>
					           	</div>	
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="退货号码：">退货号码：</label>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="pursupbackdetail:purSupBackDetail:add">
				<a id="add" class="btn btn-primary" href="${ctx}/pursupbackdetail/purSupBackDetail/form" title="供应商退货明细"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="pursupbackdetail:purSupBackDetail:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="pursupbackdetail:purSupBackDetail:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="pursupbackdetail:purSupBackDetail:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/pursupbackdetail/purSupBackDetail/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="purSupBackDetailTable"   data-toolbar="#toolbar"></table>
