...
<div class="row">
	...
	<div class="panel panel-primary">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
							<div class='input-group form_datetime' id='applyDate'>
			                    <input type='text'  name="applyDate" class="form-control required"  value="<fmt:formatDate value="${applyMain.applyDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
		...
		<div  class="tabs-container">
			...
			<a class="btn btn-white btn-sm" onclick="addRow('#applyDetailList', applyDetailRowIdx, applyDetailTpl);applyDetailRowIdx = applyDetailRowIdx + 1;" title="新增"><i class="fa fa-plus"></i> 新增</a>
			...
			<script type="text/template" id="applyDetailTpl">//<!--
				<tr id="applyDetailList{{idx}}">
					...
					<td width="85px">
						<sys:gridselect-purmul url="${ctx}/applymain/applyMain/myData" id="applyDetailList{{idx}}_item" name="applyDetailList[{{idx}}].item.id" value="{{row.item.id}}" labelName="applyDetailList{{idx}}.item.code" labelValue="{{row.item.code}}"
					...
					<td width="70px">
						<div class='input-group form_datetime' id="applyDetailList{{idx}}_requestDate">
		                    <input type='text'  name="applyDetailList[{{idx}}].requestDate" class="form-control required "  value="{{row.requestDate}}"/>
		                    <span class="input-group-addon">
		                        <span class="glyphicon glyphicon-calendar"></span>
		                    </span>
		                </div>	
					...
					<td width="70px">
						<input id="applyDetailList{{idx}}_applyQty" name="applyDetailList[{{idx}}].applyQty" type="text" value="{{row.applyQty}}"  onchange="applyQtyChange(this)"  class="form-control  required number isFloatGteZero"/>
					</td>
					...
					<td width="70px">
						<input id="applyDetailList{{idx}}_applySum" name="applyDetailList[{{idx}}].applySum" type="text" value="{{row.applySum}}"    class="form-control number"/>
					</td>
					
					<td width="70px">
						<input id="applyDetailList{{idx}}_log1" name="applyDetailList[{{idx}}].log" type="text"   value="{{row.log}}" class="form-control "/>
					</td>
					...
					<td width="70px">
						<input id="applyDetailList{{idx}}_notes" name="applyDetailList[{{idx}}].notes" type="text" value="{{row.notes}}"    class="form-control "/>
					</td>
					...
					<td class="text-center" width="10">
						{{#delBtn}}<span class="close" onclick="delRow(this, '#applyDetailList{{idx}}')" title="删除">&times;</span>{{/delBtn}}
					</td>
				</tr>//-->
			</script>
			<script type="text/javascript">
		        ...
		        <div class="col-lg-1">
		             <div class="form-group text-center">
		                 ...
		                 -->
							...
							<input type="submit" class="btn btn-primary btn-block btn-lg btn-parsley" value="提交" onclick="changeFlag()"> &nbsp;
