...
<html>
<head>
	<title>供应商到货准时率管理</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@include file="/webpage/include/treeview.jsp" %>
	<%@include file="purInvCheckPunctualList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">供应商到货准时率列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="purInvCheckPunctual" class="form form-horizontal well clearfix">
			<div class="col-xs-12 col-sm-6 col-md-4">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="订单号码：">订单号码：</label>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="purinvcheckpunctual:purInvCheckPunctual:add">
				<a id="add" class="btn btn-primary" href="${ctx}/purinvcheckpunctual/purInvCheckPunctual/form" title="供应商到货准时率"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="purinvcheckpunctual:purInvCheckPunctual:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="purinvcheckpunctual:purInvCheckPunctual:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="purinvcheckpunctual:purInvCheckPunctual:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/purinvcheckpunctual/purInvCheckPunctual/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="purInvCheckPunctualTable"   data-toolbar="#toolbar"></table>
