		...
		<sys:message content="${message}"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					...
					<input id="taxRatio" name="taxRatioNew" htmlEscape="false"    class="form-control required" value="<fmt:formatNumber value="${purPlanMain.taxRatio}" maxIntegerDigits="4" type="percent"/>" />
				</div>
                            ...
                            $('#rollPlanNewTable').bootstrapTable({
                                ...
                                columns: [{
                                    ...
                                    ,{
                                        ...
                                        sortable: true,
                                        formatter:function(value, row , index){
                                            return jp.getDictLabel(${fns:toJson(fns:getDictList('rollplan_op_flag'))}, value, "-");
                                        }
