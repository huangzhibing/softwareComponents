...
<head>
	...
	<script type="text/javascript">
		...
		function addRow(list, idx, tpl, row){
           ...
           /* $("input[id^='_itemCodeId']").change(function () {
                console.log(this.id);
            });*/
		}
        ...
        function qtySum(obj){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    //$('#'+sumId).val(($('#'+priceId).val()*planNum).toFixed(2));
                    numberLog.set(listId+"_log",planNum);
                }
            });
...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" modelAttribute="purPlanMain" action="${ctx}/purplan/purPlanMain/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
<div class="table-responsive" style="min-height: 250px">
			...
			<script type="text/template" id="purPlanDetailTpl">//<!--
				<tr id="purPlanDetailList{{idx}}">
					...
					<%--
					<td>
						<input id="purPlanDetailList{{idx}}_buyerId" name="purPlanDetailList[{{idx}}].buyerId.id" type="text" value="${fns:getUser().id}"  readonly="true"  class="form-control "/>
					</td>
					
					
					<td>
						<input id="purPlanDetailList{{idx}}_buyerName" name="purPlanDetailList[{{idx}}].buyerName" type="text" value="${fns:getUser().name}"  readonly="true"  class="form-control "/>
					</td>
