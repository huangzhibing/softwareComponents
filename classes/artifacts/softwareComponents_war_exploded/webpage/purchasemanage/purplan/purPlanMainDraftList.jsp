...
<head>
	...
	<%@include file="purPlanMainDraftList.js" %>
</head>
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-3">
				...
				<form:select cssClass="form-control "   path="billStateFlag">
					<form:option value="" label=""/>
					<form:options items="${fns:getDictList('purplan_input_flag')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="purplan:purPlanMain:add">
				<a id="add" class="btn btn-primary" href="${ctx}/purplan/purPlanMainDraft/form" title="采购计划制定"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="purplan:purPlanMain:list">
			    <button id="detail" class="btn btn-warning" onclick="detail()">
	            	 <i class="glyphicon glyphicon-folder-open"></i>  详情
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="purplan:purPlanMain:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="purplan:purPlanMain:del">
