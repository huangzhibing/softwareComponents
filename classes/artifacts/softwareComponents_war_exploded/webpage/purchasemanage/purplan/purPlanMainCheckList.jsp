...
<head>
	...
	<%@include file="purPlanMainCheckList.js" %>
</head>
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<%--@elvariable id="purPlanMainCheck" type="com.hqu.modules.purchasemanage.purplan.entity.PurPlanMain"--%>
			<form:form id="searchForm" modelAttribute="purPlanMainCheck" class="form form-horizontal well clearfix">
            <div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-3">
				<label class="label-item single-overflow pull-left" title="物料编码：">物料编码：</label>
										<sys:gridselect-pursup url="${ctx}/item/item/data2" id="itemCode" name="itemCode.id" value="${purPlanMainCheck.itemCode}" labelName="itemCode.code" labelValue="${purPlanMainCheck.itemCode}"
        ...
        <div class="row"/>
				...
				<sys:userselect-update id="makeEmpid" name="makeEmpid.id" value="${purPlanMainCheck.makeEmpid.id}" labelName="makeEmpid.no" labelValue="${purPlanMainCheck.makeEmpid.no}"
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-3">
				<label class="label-item single-overflow pull-left" title="计划类型编码：">计划类型编码：</label>
										<sys:gridselect-pursup url="${ctx}/plantype/planType/data" id="planTypeCode" name="planTypeCode.id" value="${purPlanMainCheck.planTypeCode.id}" labelName="planTypeCode.plantypeId" labelValue="${purPlanMainCheck.planTypeCode.plantypeId}"
				 ...
				 <div class="form-group">
					...
					<div class="col-xs-12">
						   <div class="col-xs-12 col-sm-6">
					        	  <div class='input-group date' id='beginPlanDate'  >
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="purplan:purPlanMainCheck:list">
			    <button id="detail" class="btn btn-warning" onclick="detail()">
	            	 <i class="glyphicon glyphicon-folder-open"></i>  详情
	        	</button>
			</shiro:hasPermission>

			<%--<shiro:hasPermission name="purplan:purPlanMainCheck:del">--%>
	...
	<!-- 表格 -->
	<table id="purPlanMainCheckTable"   data-toolbar="#toolbar"></table>
