...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" modelAttribute="contractMain" action="${ctx}/contractmain/contractMainClose/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				...
				<label class="col-sm-2 control-label">合同类型：</label>
					...
					<div class="col-sm-3">
						<form:input path="contractNeedSum" htmlEscape="false"  readOnly="true"  class="form-control  number"/>
					</div>
				</div>
				<div class="form-group">
			...
			<%-- 	<div class="form-group">
					...
					<div class="col-sm-3">
						<form:input path="advancePay" htmlEscape="false"  readOnly="true"  class="form-control  number"/>
					</div>
				</div>
			 --%>
				<div class="form-group">
		...
		<c:if test="${fns:hasPermission('contractmainclose:contractMain:edit') || isAdd}">
		        ...
		        <div class="form-group text-center">
		                 <div>
		                 	<a href= "${ctx}/contractmain/contractMainClose" class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在保存...">返回</a>                  
		                 </div>
		             </div>
		        </div>
		</c:if>
