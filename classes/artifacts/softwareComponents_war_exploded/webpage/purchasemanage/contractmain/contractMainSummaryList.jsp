...
<head>
	...
	<%@include file="contractMainSummaryList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购订单汇总列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="contractDetailSummary" class="form form-horizontal well clearfix">
	...
	<div id="toolbar">
				...
				<shiro:hasPermission name="contractmainsummary:contractMain:list">
