...
<head>
	...
	<%@include file="contractMainList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购合同录入列表</h3>
	</div>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="contractmain:contractMain:add">
			...
			<shiro:hasPermission name="contractmain:contractMain:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="contractmain:contractMain:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="contractmain:contractMain:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/contractmain/contractMain/import" method="post" enctype="multipart/form-data"
