...
<head>
	...
	<script type="text/javascript">
		...
		//	$("#inputForm").submit();
		$.post("${ctx}/contractmain/contractMainUnfreeze/save",$('#inputForm').serialize(),function(data){			
			jp.success(data.msg);
		});
		}
...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" modelAttribute="contractMain" action="${ctx}/contractmain/contractMainUnfreeze/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="tabs-container">
			...
			<script type="text/template" id="contractDetailTpl">//<!--
				<tr id="contractDetailList{{idx}}">
					...
					<td>
						<input id="contractDetailList{{idx}}_item" name="contractDetailList[{{idx}}].item.code"  type="text" readOnly="true" value="{{row.item.code}}" class="form-control required"/>
	                ...
	                <td>
						<input id="contractDetailList{{idx}}_itemModel" name="contractDetailList[{{idx}}].itemModel" type="text" readOnly="true" value="{{row.itemModel}}"    class="form-control required"/>
					</td>
					
					
					<td>
						<input id="contractDetailList{{idx}}_itemTexture" name="contractDetailList[{{idx}}].itemTexture" type="text" readOnly="true" value="{{row.itemTexture}}"    class="form-control"/>
					</td>
					...
					<td>
						<input id="contractDetailList{{idx}}_itemQty" name="contractDetailList[{{idx}}].itemQty" type="text" readOnly="true" value="{{row.itemQty}}"  onchange="setSumValue(this)"   class="form-control number required"/>
					</td>
					
					
					<td>
						<input id="contractDetailList{{idx}}_itemPrice" name="contractDetailList[{{idx}}].itemPrice" type="text" readOnly="true" value="{{row.itemPrice}}"  onchange="setItemPrice(this)"  class="form-control number required"/>
					</td>
					
					
					<td>
						<input id="contractDetailList{{idx}}_itemSum" name="contractDetailList[{{idx}}].itemSum"  type="text" readOnly="true" value="{{row.itemSum}}"  readOnly="true"  class="form-control number required"/>
					</td>
					
					
					<td>
						<input id="contractDetailList{{idx}}_itemPriceTaxed" name="contractDetailList[{{idx}}].itemPriceTaxed" type="text" readOnly="true" value="{{row.itemPriceTaxed}}" onchange="setItemPriceTaxed(this)"   class="form-control number required"/>
					</td>
					...
					<td>
						<input id="contractDetailList{{idx}}_transPrice" name="contractDetailList[{{idx}}].transPrice" type="text" value="{{row.transPrice}}"  onchange="setTransPrice(this)" readOnly="true" class="form-control number"/>
					</td>
					
					
					<td>
						<input id="contractDetailList{{idx}}_transSum" name="contractDetailList[{{idx}}].transSum" type="text" value="{{row.transSum}}"  readOnly="true" readOnly="true" class="form-control number"/>
					</td>
		...
		<c:if test="${fns:hasPermission('contractmainunfreeze:contractMain:edit') || isAdd}">
		      <div class="row">
				<%-- 	<div class="col-lg-2"></div>
			        <div class="col-lg-3">
			             <div class="form-group text-center">
			                 <div>
			                 	  <button class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在提交...">解冻</button>   		                 
			                 </div>
			             </div>
			        </div>
			        <div class="col-lg-2"></div>
			        ...
			        <div class="form-group text-center">
			                 <div>
			                    <a href= "${ctx}/contractmain/contractMainUnfreeze" class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在保存...">返回</a>                  
			                 </div>
			             </div>
			        </div>
			       --%>
