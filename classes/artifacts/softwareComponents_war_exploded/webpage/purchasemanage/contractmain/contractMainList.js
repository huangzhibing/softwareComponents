...
$(document).ready(function() {
	$('#contractMainTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/contractmain/contractMain/data",
          ...
          //     contextMenu: '#context-menu',
			...
			,{
		        ...
		        ,formatter:function(value, row , index){
		        	return "<a href='${ctx}/contractmain/contractMain/form?id="+row.id+"'>"+value+"</a>";
		         }
  ...
  function edit(){
	  window.location = "${ctx}/contractmain/contractMain/form?id=" + getIdSelections();
  }
