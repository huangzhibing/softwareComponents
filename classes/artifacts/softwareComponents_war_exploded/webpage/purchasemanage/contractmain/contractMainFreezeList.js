...
$(document).ready(function() {
	$('#contractMainTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/contractmain/contractMainFreeze/data",
         ...
         //      contextMenu: '#context-menu',
			...
			,{
		        ...
		        ,formatter:function(value, row , index){
		        	return "<a href='${ctx}/contractmain/contractMainFreeze/form?id="+row.id+"'>"+value+"</a>";
		         }
  ...
  function detail(){
	  window.location = "${ctx}/contractmain/contractMainFreeze/form?id=" + getIdSelections();
  }
