...
$(document).ready(function() {
	$('#contractMainTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/contractmain/contractMainClose/data",
         ...
         //      contextMenu: '#context-menu',
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/contractmain/contractMainClose/form?id=" + row.id;
			...
			,{
		        ...
		        ,formatter:function(value, row , index){
		        	return "<a href='${ctx}/contractmain/contractMainClose/form?id="+row.id+"'>"+value+"</a>";
		         }
  ...
  function detail(){
	  ...
	  window.location = "${ctx}/contractmain/contractMainClose/form?id=" + getIdSelections();
  }
