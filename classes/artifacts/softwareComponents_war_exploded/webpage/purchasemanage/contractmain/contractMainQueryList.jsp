...
<head>
	...
	<%@include file="contractMainQueryList.js" %>
</head>
<body>
	...
	<div id="toolbar">
		...
		--%>	<shiro:hasPermission name="contractmainquery:contractMain:edit">
		...
		--%>	<shiro:hasPermission name="contractmainquery:contractMain:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/contractmain/contractMainQuery/import" method="post" enctype="multipart/form-data"
    ...
    <ul id="context-menu" class="dropdown-menu">
        ...
        <shiro:hasPermission name="contractmainquery:contractMain:del">
