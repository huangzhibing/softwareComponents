...
$(document).ready(function() {
	$('#contractMainTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/contractmain/contractMainCheck/data",
            ...
            //   contextMenu: '#context-menu',
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/contractmain/contractMainCheck/form?id=" + row.id;
			...
			,{
		        ...
		        ,formatter:function(value, row , index){
		        	return "<a href='${ctx}/contractmain/contractMainCheck/form?id="+row.id+"'>"+value+"</a>";
		         }
  ...
  function detail(){
	 // alert(getIdSelections());
	  window.location = "${ctx}/contractmain/contractMainCheck/form?id=" + getIdSelections();
  }
  //采购员标签内函数
  ...
  function detailFormatter(index, row) {
	  ...
	  $.get("${ctx}/contractmain/contractMainClose/detail?id="+row.id, function(contractMain){
