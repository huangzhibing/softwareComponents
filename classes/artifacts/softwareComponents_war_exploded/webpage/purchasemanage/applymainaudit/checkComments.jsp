...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" modelAttribute="adtDetail" action="${ctx}/applymainaudit/applyMainAudit/subSaveAdt" method="post" class="form-horizontal">
		<%--<form:hidden path="id"/>
		   ...
		   <div class="col-md-2 col-xs-2 form-group">
		           ...
		           <div class="col-lg-2">
		             <div class="form-group text-center">
		                 <div>
		                     <button class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在提交..." onclick="closewindow()">提 交</button>
		                 </div>
		             </div>
		            </div>
		            </div>
