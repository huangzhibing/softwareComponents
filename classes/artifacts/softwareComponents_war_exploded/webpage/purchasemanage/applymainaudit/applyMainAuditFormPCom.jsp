...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" modelAttribute="applyMainAudit" action="${ctx}/applymain/applyMain/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<sys:gridselect-modify url="${ctx}/applytype/applyType/data" id="applyType" name="applyType.id" value="${applyMain.applyType.id}" labelName="applyType.applytypeid" labelValue="${applyMainAudit.applyType.applytypeid}"
							 title="选择需求类别编码" 
