        ...
        $('#mpsPlanTable').bootstrapTable({
            ...
            onContextMenuItem: function(row, $el){
                if($el.data("item") == "edit"){
                    window.location = "${ctx}/ppc/mrpPlan/form?id=" + row.id;
            ...
            columns: [{
                ...
                ,{
                    ...
                    ,formatter:function(value, row , index){
                        return "<a href='${ctx}/ppc/mrpPlan/form?id="+row.id+"'>"+value+"</a>";
                    }
...
function makeMRP(){
    jp.loading("生成中。。。");
    jp.get("${ctx}/ppc/mrpPlan/makeMRP",function(data){
        if (data.success) {
            jp.success(data.msg);
...
function edit(){
    window.location = "${ctx}/ppc/mrpPlan/form?id=" + getIdSelections();
}
