...
<script>
 $(document).ready(function() {
    $('#mpsPlanTable').bootstrapTable({
        ...
        onContextMenuItem: function(row, $el){
            if($el.data("item") == "edit"){
                window.location = "${ctx}/ppc/mpsPlan/auditForm?id=" + row.id;
        ...
        ,{
            ...
            ,formatter:function(value, row , index){
                return "<a href='${ctx}/ppc/mpsPlan/auditForm?id="+row.id+"'>"+value+"</a>";
            }
    ...
    function audit(){
    window.location = "${ctx}/ppc/mpsPlan/auditForm?id=" + getIdSelections();
}
