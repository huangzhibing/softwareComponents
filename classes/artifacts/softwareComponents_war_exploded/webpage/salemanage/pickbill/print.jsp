 ...
 collapse;table-layout:fixed;'>
  ...
  width:554pt'>地址：湖南省常德市鼎城区灌溪镇高新技术开发区科技创新创业产业园厂房第10栋</td>
        ...
        <tr height=34 style='height:25.5pt'>
            <td colspan=10 height=34 class=xl159 style='height:25.5pt'>出 货 通 知 <span style="float: right;font-size: 10px">NO:${pickBill.pbillCode}</span></td>
        </tr>
        <tr height=29 style='mso-height-source:userset;height:21.95pt'>
            <td colspan=8 height=29 class=xl155 width=52 style='height:21.95pt;width:39pt'></td>
            <td colspan=4 class=xl168 width=318 style='width:239pt'>客户:${pickBill.rcvAccountName}</td>
        </tr>
        <tr height=29 style='mso-height-source:userset;height:21.95pt'>
            <td colspan=8 height=29 class=xl155 width=52 style='height:21.95pt;width:39pt'></td>
            <td colspan=4 class=xl168 width=318 style='width:239pt'>出货日期:<fmt:formatDate value="${pickBill.pickDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
        </tr>
    ...
    <table  border=0 cellpadding=0 cellspacing=0 width=737 style='border-collapse:collapse;width: 100%'>
        <colgroup><col width="52" style="mso-width-source:userset;mso-width-alt:1664;width:1%">
            ...
            <col width="70" style="mso-width-source:userset;mso-width-alt:2240;width:2%">
        ...
        <tr class=xl130 height=28 style='mso-height-source:userset;height:21.0pt'>
            ...
            <td class=xl154  style='border-left:none;'>销售单号</td>
            <td class=xl154  style='border-left:none;'>生产单号</td>
            <td class=xl156 style='border-left:none'>产品料号</td>
            <td class=xl161 style='border-left:none'>产品名称</td>
            <td class=xl154  style='border-left:none;'>规格型号</td>
            <td class=xl154 style='border-left:none;'>数量</td>
            <td class=xl154 style='border-left:none;'>配件</td>
    ...
    <table  style="table-layout:fixed;width: 100%">
        <td class=xl158 style="text-align: left">制单:${pickBill.pbillPsnName}</td>
        <td class=xl158 style="text-align: left">业务经理:</td>
    ...
    <script type="text/template" id="contractDetailTpl">
        <tr height=37 style='mso-height-source:userset;height:28.35pt'>
            ...
            <td class=xl133  style='text-align: center'>　${pickBill.contract.contractCode}</td>
            <td class=xl134  style='text-align: center'>　</td>
            <td class=xl134  style='text-align: center'>{{row.prodCode.item.code}}　</td>
            <td class=xl136 style='text-align: center'><span
                    style='mso-spacerun:yes'>&nbsp;</span>{{row.prodName}} </td>
            <td  class=xl137 style='border-left:none;width:53pt'>{{row.prodSpec}}</td>
            <td class='xl136'  style='text-align: center'>{{row.pickQty}}</td>
            <td class='xl136'  style='text-align:center'>{{row.unitName}}</td>
