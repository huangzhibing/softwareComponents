...
<body>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="salorder:salOrder:add">
				<a id="add" class="btn btn-primary" href="${ctx}/salorder/salOrder/form" title="内部订单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
