...
$(document).ready(function() {
		  ...
		  //请求方法
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/salcontract/contract/form?id=" + row.id;
			...
			,{
		        ...
		        ,formatter:function(value, row , index){
		        	return "<a href='${ctx}/salcontract/contract/form?id="+row.id+"'>"+value+"</a>";
		         }
		    }
			,{
		        field: 'signDate',
  ...
  function edit(){
	  window.location = "${ctx}/salcontract/contract/form?id=" + getIdSelections();
  }
