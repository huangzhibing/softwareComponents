	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/newinvcheckmain/newinvCheckMain/HGGSearch"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="billMain" action="${ctx}/newinvcheckmain/newinvCheck/HGuozhang" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
			...
			<div class="tabs-container">
				...
				<tr id="billDetailCodeList{{idx}}">
					...
					<td>
						<input  id="billDetailCodeList{{idx}}_itemBarcode" name="billDetailCodeList[{{idx}}].itemBarcode" type="text" value="{{row.itemBarcode}}"    class="form-control"/>
					</td>
					<td>
