...
<head>
	...
	<%@include file="newinvCheckMainSearchList.js" %>
</head>
<body>
				...
				<div id="collapseTwo" class="accordion-body collapse">
					<div class="accordion-inner">
						<form:form id="searchForm" modelAttribute="newinvCheckMain" class="form form-horizontal well clearfix">
							...
							<div class="col-xs-12 col-sm-6 col-md-4">
								<label class="label-item single-overflow pull-left" title="复验员编码：">复验员编码：</label>
								<sys:userselect id="checkEmpId" name="checkEmpId.id" value="${newinvCheckMain.checkEmpId.id}" labelName="checkEmpId.no" labelValue="${newinvCheckMain.checkEmpId.no}"
												cssClass="form-control "/>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-4">
