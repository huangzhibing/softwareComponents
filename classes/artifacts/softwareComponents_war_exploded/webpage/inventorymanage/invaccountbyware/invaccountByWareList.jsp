...
<html>
<head>
	<title>库存帐按仓库查询</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@include file="/webpage/include/treeview.jsp" %>
	<%@include file="invaccountByWareList.js" %>
	<%@include file="invaccountByWareTreeList.js"%>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">库存帐按仓库查询</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="invaccountByWare" class="form form-horizontal well clearfix">
				...
				<div class="col-xs-12 col-sm-6 col-md-3">
					...
					<sys:gridselect-item url="${ctx}/warehouse/wareHouse/data" id="ware" name="ware.id" value="${invaccountByItem.ware.id}" labelName="ware.wareID" labelValue="${billMain.ware.wareID}"
	...
	<!-- 表格 -->
	<table id="invaccountByWareTable"   data-toolbar="#toolbar"></table>
