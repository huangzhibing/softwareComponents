	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/outsourcingoutput/outsourcingOutput/notAuditList"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form  id="inputForm" modelAttribute="billMain" action="${ctx}/outsourcingoutput/outsourcingOutput/formNotAuditdo" method="post" class="form-horizontal">
		<form:hidden path="id"/>
 ...
 --%>							<input value="待过账" readOnly="true"     class="form-control required"/>
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input  path="note" htmlEscape="false"    class="form-control required"/>
					</div>
				</div>
		...
		<c:if test="${fns:hasPermission('billmain:billMain:edit') || isAdd}">
		        ...
		        <div class="col-lg-6">
		             <div class="form-group text-center">
		                 <div>
		                     <button id="submitBtn" class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在提交...">反过账</button>
		                 </div>
		             </div>
		        </div>
		</c:if>
