	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/outsourcingoutput/outsourcingOutput/auditList"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form  id="inputForm" modelAttribute="billMain" action="${ctx}/outsourcingoutput/outsourcingOutput/formAuditdo" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
<%-- 						<form:select path="billFlag" class="form-control required" disabled="true">
 --%>							<input value="待过账" readOnly="true"     class="form-control required"/>
			...
			<input style="display:none;" id="wareIdd" bi'l'lname="ware.wareID" value="${billMain.ware.wareID }" />
				<div class="form-group">
				...
				<input id="subFlag" style="display:none;"/>
				 <div class="form-group">
					...
					<div class="col-sm-10">
						...
						<form:input disabled="disabled" placeHolder="点击获取经办人"  readOnly="true"  id="billPersonId"  value="${billMain.billPerson.no}" path="billPerson.no"
							    cssClass="form-control required"/>
					</div>
				</div> 
		...
		<div class="tabs-container">
			...
			<script type="text/template" id="billDetailTpl">//<!--
				<tr id="billDetailList{{idx}}" onmousemove="getSum(this.id)">
					...
					<td>
						<input readOnly="readOnly onkeyup="calSum(this.value,this.id)"  id="billDetailList{{idx}}_itemPrice" name="billDetailList[{{idx}}].itemPrice" type="text" value="{{row.itemPrice}}"    class="form-control"/>
					</td>
		...
		<c:if test="${fns:hasPermission('billmain:billMain:edit') || isAdd}">
		        ...
		        <div class="col-lg-3">
		             <div class="form-group text-center">
		                 <div>
		                     <button value="1" name="audit_btn" id="submitBtn" class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在提交...">过 账</button>
		                 </div>
		             </div>
		        </div>
			...
			<div class="col-lg-3">
				<div class="form-group text-center">
					<div>
						<button value="2" name="submit_btn" class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在提交...">再次发送指令</button>
					</div>
				</div>
			</div>
		</c:if>
