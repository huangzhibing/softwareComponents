<%@ page contentType="text/html;charset=UTF-8" %>
    ...
    $(document).ready(function() {
        $('#billMainTable').bootstrapTable({
            ...
            url: "${ctx}/outboundinput/outboundInput/data?billFlag=T",
            ...
            onContextMenuItem: function(row, $el){
                if($el.data("item") == "edit"){
                    window.location = "${ctx}/outboundinput/outboundInput/form?type=Query&id=" + row.id;
            ...
            columns: [
                ...
                ,{
                    ...
                    ,formatter:function(value, row , index){
                        return "<a href='${ctx}/outboundinput/outboundInput/form?type=fan&id="+row.id+"'>"+value+"</a>";
                    }
