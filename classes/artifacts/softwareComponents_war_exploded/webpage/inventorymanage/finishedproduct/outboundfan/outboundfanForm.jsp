            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="panelButton" href="${ctx}/outboundinput/outboundInput?type=fan"><i class="ti-angle-left"></i> 返回</a>
                    </h3>
                </div>
                <div class="panel-body">
                    <form:form id="inputForm" modelAttribute="billMain" action="${ctx}/outboundinput/outboundInput/formNotAuditdo" method="post" class="form-horizontal">
                        <form:hidden path="id"/>
                        ...
                        <c:if test="${fns:hasPermission('billmain:billMain:edit') || isAdd}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group text-center">
                                    <div>
                                        <button class="btn btn-primary btn-block btn-lg btn-parsley" data-loading-text="正在提交...">反过账</button>
                                    </div>
                                </div>
                            </div>
                        </c:if>
