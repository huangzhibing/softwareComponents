            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="panelButton" href="${ctx}/outboundinput/outboundInput?type=Post"><i class="ti-angle-left"></i> 返回</a>
                    </h3>
                </div>
                <div class="panel-body">
                    <form:form id="inputForm" modelAttribute="billMain" action="${ctx}/outboundinput/outboundInput/post" method="post" class="form-horizontal">
                        <form:hidden path="id"/>
				...
				<tr id="billDetailList{{idx}}">
					...
					<td>
						<input id="billDetailList{{idx}}_serialNum" readonly name="billDetailList[{{idx}}].serialNum" type="text" value="{{row.serialNum}}"    class="form-control required"/>
					</td>
                    <td>
