...
$(document).ready(function() {
		  ...
		  //请求方法
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                       jp.openDialog('编辑货位',"${ctx}/warehouse/wareHouse/form?id=" + row.id,'800px','500px',$('#wareHouseTable'))
  ...
  function edit(){
      jp.openDialog('编辑货位',"${ctx}/warehouse/wareHouse/form?id=" + getIdSelections(),'800px','500px',$('#wareHouseTable'))
