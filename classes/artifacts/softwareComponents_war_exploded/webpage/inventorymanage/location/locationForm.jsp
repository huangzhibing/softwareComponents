...
//					form.submit();
                    ...
                    $.post("${ctx}/location/location/save",$('#inputForm').serialize(),function(data){

                        if(data.success){
                            $table.bootstrapTable('refresh');
//                            window.parent.$("#wareHouseJsTree").jstree().refresh();
...
<div class="row">
	...
	<div class="panel panel-primary">
		...
		<form:form id="inputForm" modelAttribute="location" action="${ctx}/location/location/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>货位号：</label>
					<div class="col-sm-10">
						<form:input readonly="true" path="locId" htmlEscape="false"    class="form-control required"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">货位名称：</label>
					<div class="col-sm-10">
						<form:input path="locDesc" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
