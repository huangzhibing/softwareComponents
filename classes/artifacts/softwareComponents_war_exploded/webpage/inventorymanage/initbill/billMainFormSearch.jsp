	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/initbill/initBill/searchList"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		...
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input id="note" readOnly="true" path="note" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
		...
		<div class="tabs-container">
			...
			<script type="text/template" id="billDetailTpl">//<!--
				<tr id="billDetailList{{idx}}" onmousemove="getSum(this.id)">
					...
					<td>
						<input readOnly="true" onkeyup="calSum(this.value,this.id)"  id="billDetailList{{idx}}_itemPrice" name="billDetailList[{{idx}}].itemPrice" type="text" value="{{row.itemPrice}}"    class="form-control required"/>
					</td>
		...
		<div class="col-lg-3"></div>
		        <div class="col-lg-6">
		             <div class="form-group text-center">
		                 <div>
		                 	<a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/initbill/initBill/searchList">返 回</a>
		                 </div>
		             </div>
		        </div>
		</form:form>
