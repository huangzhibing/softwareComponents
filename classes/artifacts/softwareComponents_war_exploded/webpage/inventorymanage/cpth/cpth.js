<%@ page contentType="text/html;charset=UTF-8" %>
    ...
    $(document).ready(function() {
        ...
        switch ("${mtype}") {
            case 'i':
                url = "${ctx}/billmain/billMain/data?io.ioType=CO01&billFlag=T";
                break;
            case 'c':
                url = "${ctx}/billmain/billMain/data?io.ioType=CT01";
                break;
            case 'p':
                url = "${ctx}/billmain/billMain/data?io.ioType=CT01&billFlag=N";
                break;
        }
        console.log("${mtype}")
        console.log(url)
            ...
            columns: [
                ...
                ,{
                    ...
                    ,formatter:function(value, row , index){
                        return "<a href='${ctx}/cpth/cpth/form?mtype=${mtype}&id="+row.id+"'>"+value+"</a>";
                    }
        ...
        $("#btnImport").click(function(){
            jp.open({
                ...
                btn1: function(index, layero){
                    window.location='${ctx}/outboundinput/outboundInput/import/template';
                },
