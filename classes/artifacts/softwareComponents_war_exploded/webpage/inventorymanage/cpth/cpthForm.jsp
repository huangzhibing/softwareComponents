...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            if("p"=="${mtype}"){
                document.getElementById('inputForm').action="${ctx}/cpth/cpth/post"
            }
            $("#inputForm").validate({
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="panelButton" href="${ctx}/cpth/cpth?mtype=${mtype}"><i class="ti-angle-left"></i> 返回</a>
                    </h3>
                </div>
                <div class="panel-body">
                        <form:form id="inputForm" modelAttribute="billMain"  action="${ctx}/cpth/cpth/save" method="post" class="form-horizontal">
                        <form:hidden path="id"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input value="待过账" readonly="ture" class="form-control required"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class='input-group form_datetime' id='billDate'>
                                    <input type='text'  name="billDat" class="form-control required"  value="<fmt:formatDate value="${billMain.billDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <sys:gridselect-item disabled="disabled"   extraField="accountId:accountCode;accountNames:accountCode;accountNamed:accountName"  url="${ctx}/account/account/data?accTypeNameRu=客户" id="account" name="account.id" value="${billMain.account.id}" labelName="account.accountCode" labelValue="${billMain.account.accountCode}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <sys:treeselect-modify disabled="disabled" id="dept" name="dept.id" value="${billMain.dept.id}" labelName="dept.code" labelValue="${billMain.dept.code}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <sys:userselect disabled="disabled" id="billPerson" name="billPerson.id" value="${billMain.billPerson.id}" labelName="billPerson.no" labelValue="${billMain.billPerson.no}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <sys:gridselect-modify disabled="disabled" labelField="user.no"  url="${ctx}/employee/employee/data" id="wareEmp" name="wareEmp.id" value="${billMain.wareEmp.id}" labelName="wareEmp.user.no" labelValue="${billMain.wareEmp.user.no}"
                                                       title="选择库管员代码" cssClass="form-control" fieldLabels="库管员代码|库管员名称" fieldKeys="user.no|empName" searchLabels="库管员代码|库管员名称" searchKeys="user.no|empName"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <form:input path="wareEmpname"    class="form-control "/>
                            </div>
                        </div>
                        <div class="form-group">
				...
				<tr id="billDetailList{{idx}}">
					...
					<td>
						<input id="billDetailList{{idx}}_itemQty" onkeyup="getSum({{idx}})"  name="billDetailList[{{idx}}].itemQty" type="text" value="{{row.itemQty}}"    class="form-control "/>
					</td>
					<td>
						<input id="billDetailList{{idx}}_measUnit"  name="billDetailList[{{idx}}].measUnit" type="text" value="{{row.measUnit}}"    class="form-control "/>
					</td>
					<td>
						<sys:gridselect-item disabled="disabled" url="${ctx}/bin/bin/data" id="billDetailList{{idx}}_bin" name="billDetailList[{{idx}}].bin.id" value="{{row.bin.id}}" labelName="billDetailList[{{idx}}].bin.binId" labelValue="{{row.bin.id}}"
							 ...
							 targetId="billDetailList{{idx}}_binName" targetField="binDesc"></sys:gridselect-item>
					</td>
					...
					<td>
						<sys:gridselect-item disabled="disabled" url="${ctx}/location/location/data" id="billDetailList{{idx}}_loc" name="billDetailList[{{idx}}].loc.id" value="{{row.loc.id}}" labelName="billDetailList[{{idx}}].loc.locId" labelValue="{{row.loc.id}}"
							 ...
							 targetId="billDetailList{{idx}}_locName" targetField="locDesc"></sys:gridselect-item>
					</td>
                    ...
                    <td>
						<input id="billDetailList{{idx}}_itemPrice" readonly="readonly" name="billDetailList[{{idx}}].itemPrice" type="text" value="{{row.itemPrice}}"    class="form-control "/>
					</td>


					<td>
						<input id="billDetailList{{idx}}_itemSum" readonly="readonly" name="billDetailList[{{idx}}].itemSum" type="text" value="{{row.itemSum}}"    class="form-control "/>
					</td>
