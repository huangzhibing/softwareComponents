 ...
 collapse;table-layout:fixed;'>
  ...
  width:554pt'>地址：湖南省常德市鼎城区灌溪镇高新技术开发区科技创新创业产业园厂房第10栋</td>
        ...
        <tr height=34 style='height:25.5pt'>
            <td colspan=10 height=34 class=xl159 style='height:25.5pt'>退 货 单 <span style="float: right;font-size: 10px">NO:${billMain.billNum}</span></td>
        </tr>
        <tr height=29 style='mso-height-source:userset;height:21.95pt'>
            <td colspan=8 height=29 class=xl155 width=52 style='height:21.95pt;width:39pt;text-align: left'>供应商:${billMain.accountName}</td>
            <td colspan=4 class=xl168 width=318 style='width:239pt'>退货日期:<fmt:formatDate value="${billMain.billDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
        </tr>
    ...
    <table  border=0 cellpadding=0 cellspacing=0 width=737 style='border-collapse:collapse;width: 100%'>
        ...
        <tr class=xl130 height=28 style='mso-height-source:userset;height:21.0pt'>
            <td colspan=1 height=28 class=xl160 style='height:21.0pt'>序号</td>
            <td colspan=2 class=xl154  style='border-left:none;'>生产单号</td>
            <td colspan=2 class=xl154  style='border-left:none;'>料号</td>
            <td colspan=2 class=xl156 style='border-left:none'>品名规格</td>
            <td colspan=1 class=xl161 style='border-left:none'>单位</td>
            <td colspan=1 class=xl154  style='border-left:none;'>数量</td>
            <td colspan=2 class=xl154 style='border-left:none;'>退货原因</td>
    ...
    <table  style="table-layout:fixed;width: 100%">
        <td class=xl158 style="text-align: left">仓库:${billMain.wareName}</td>
        <td class=xl158 style="text-align: left">采购:</td>
        <td class=xl158 style="text-align: left">供应商:${billMain.accountName}</td>
    </table>
    ...
    <script type="text/template" id="contractDetailTpl">
        <tr height=37 style='mso-height-source:userset;height:28.35pt'>
            ...
            <td colspan="2" class=xl133 width=94  style='text-align: center'>　</td>
            <td colspan="2" class=xl134 width=83  style='text-align: center'>　{{row.item.id}}</td>
            <td colspan="2" class=xl134 width=88  style='text-align: center'>{{row.itemName}}　</td>
            <td class=xl136 width=61 style='text-align: center'><span
                    style='mso-spacerun:yes'>&nbsp;</span>{{row.measUnit}} </td>
            <td  class=xl137 width=70 style='border-left:none;width:53pt'>{{row.itemQty}}</td>
            <td colspan="2" class='xl136' width=41  style='text-align: center'></td>
            <td colspan="2" class='xl136' width=41  style='text-align: center'></td>
        </tr>
    </script>
