...
$(document).ready(function() {
	...
	$('#myTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               url: "${ctx}/plananduse/plananduse/data?io.ioType=WO01&billFlag=T",
               ...
               queryParams : function(params) {
	               	...
	               	searchParam.userDeptCode=searchParam['dept.code'];
	               	searchParam["itemCode.name"]=searchParam['itemName'];
	               	searchParam["itemCode.specModel"]=searchParam.itemSpec;
	               	searchParam.beginMakeDate=searchParam.beginBillDate
	               	searchParam.endMakeDate=searchParam.endBillDate
                   searchParam.userDeptCode=searchParam["dept.codes"]
	                return searchParam;
               },
            ...
            ,{
                ...
                ,formatter:function(value, row , index){
                	if(row.planQty==null||row.itemQty==null) return;
		        	return  row.planQty-row.itemQty;
		         }
            }
            ,{
                field: 'planSum',
            ...
            ,{
                ...
                sortable: true
                ,formatter:function(value, row , index){
                	if(row.planSum==null||row.itemSum==null) return;
		        	return  row.planSum-row.itemSum;
		         }
            }
		     ]
