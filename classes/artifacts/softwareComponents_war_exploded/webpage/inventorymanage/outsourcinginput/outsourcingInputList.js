...
$(document).ready(function() {
        $('#billMainTable').bootstrapTable({
            ...
            url: "${ctx}/outsourcinginput/outsourcingInput/data?type=${type}",
            ...
            columns: [
                ...
                ,{
                    ...
                    ,formatter:function(value, row , index){
                        if('${type}' === 'Input') {
                            return "<a href='${ctx}/outsourcinginput/outsourcingInput/form?type=Input&id=" + row.id + "'>" + value + "</a>";
                        }
                        if('${type}' === 'Query') {
                            return "<a href='${ctx}/outsourcinginput/outsourcingInput/form?type=Query&id=" + row.id + "'>" + value + "</a>";
                        }
                        if('${type}' === 'Post') {
                            return "<a href='${ctx}/outsourcinginput/outsourcingInput/form?type=Post&id=" + row.id + "'>" + value + "</a>";
                        }
                        if('${type}' === 'Unpost') {
                            return "<a href='${ctx}/outsourcinginput/outsourcingInput/form?type=Unpost&id=" + row.id + "'>" + value + "</a>";
                        }
                    }
                }
                ,{
