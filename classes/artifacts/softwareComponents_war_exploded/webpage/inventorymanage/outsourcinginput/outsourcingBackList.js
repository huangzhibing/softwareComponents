...
$(document).ready(function() {
        $('#billMainTable').bootstrapTable({
            ...
            url: "${ctx}/outsourcinginput/outsourcingInput/Back?type=${type}",
            ...
            columns: [
                ...
                ,{
                    ...
                    ,formatter:function(value, row , index){
                        if('${type}' === 'BInput') {
                            return "<a href='${ctx}/outsourcinginput/outsourcingInput/form?type=BInput&id=" + row.id + "'>" + value + "</a>";
                        }
                        if('${type}' === 'BAudit') {
                            return "<a href='${ctx}/outsourcinginput/outsourcingInput/form?type=BAudit&id=" + row.id + "'>" + value + "</a>";
                        }
                        if('${type}' === 'BPost') {
                            return "<a href='${ctx}/outsourcinginput/outsourcingInput/form?type=BPost&id=" + row.id + "'>" + value + "</a>";
                        }
                        if('${type}' === 'BQuery') {
                            return "<a href='${ctx}/outsourcinginput/outsourcingInput/form?type=BQuery&id=" + row.id + "'>" + value + "</a>";
                        }
                    }
                }
                ,{
