            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="panelButton" href="${ctx}/outsourcinginput/outsourcingInput?type=${type}"><i class="ti-angle-left"></i> 返回</a>
                    </h3>
                </div>
                <div class="panel-body">
                    <form:form id="inputForm" modelAttribute="billMain" action="${ctx}/outsourcinginput/outsourcingInput/save?type=${type}" method="post" class="form-horizontal">
                        <form:hidden path="id"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 input-group">
                                ...
                                <c:if test="${type eq 'Query'}">
                                    <input disabled="disabled" htmlEscape="false" value="${billMain.corBillNum}"   class="form-control"/>
                                    <span class="input-group-btn">
                                             <button type="button"  class="btn   btn-primary  "><i class="fa fa-search"></i>
                                             </button>
                                        </button>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <c:if test="${type eq 'Query'}">
                                    <sys:gridselect-item disabled="disabled" url="${ctx}/warehouse/wareHouse/data" id="ware" name="ware.id" value="${billMain.ware.id}" labelName="ware.wareID" labelValue="${billMain.ware.wareID}"
                                                          title="选择库房号" cssClass="form-control" fieldLabels="库房号|库房名称" fieldKeys="wareID|wareName" searchLabels="库房号|库房名称" searchKeys="wareID|wareName"
                                                          targetId="wareName" targetField="wareName"></sys:gridselect-item>
                                </c:if>
                                <c:if test="${type eq 'Post'}">
				...
				<tr id="billDetailList{{idx}}">
                    ...
                    <c:if test="${type eq 'Query'}">
					<td>
						<input id="billDetailList{{idx}}_itemQty" readonly="readonly" name="billDetailList[{{idx}}].itemQty" type="text" value="{{row.itemQty}}" onkeyup="getItemSum('billDetailList{{idx}}')"  class="form-control "/>
					</td>
                    </c:if>
                    <c:if test="${type eq 'Post'}">
					<td>
                    ...
                    <c:if test="${type eq 'Query'}">
                    <td>
						<sys:gridselect-modify disabled="disabled"  url="${ctx}/bin/bin/data" id="billDetailList{{idx}}_bin" name="billDetailList[{{idx}}].bin.id" value="{{row.bin.id}}" labelName="billDetailList{{idx}}.bin.binId" labelValue="{{row.bin.binId}}"
							 title="选择货区号" cssClass="form-control  " fieldLabels="货区编码|货区名称" fieldKeys="binId|binDesc" searchLabels="货区编码|货区名称" searchKeys="binId|binDesc"
							 targetId="billDetailList{{idx}}_binName" targetField="binDesc"></sys:gridselect-modify>
					</td>
					...
					<c:if test="${type eq 'Query'}">
					<td>
						<sys:gridselect-modify disabled="disabled" url="${ctx}/location/location/data" id="billDetailList{{idx}}_loc" name="billDetailList[{{idx}}].loc.id" value="{{row.loc.id}}" labelName="billDetailList{{idx}}.loc.locId" labelValue="{{row.loc.locId}}"
							 title="选择货位号" cssClass="form-control  " fieldLabels="货位编码|货位名称" fieldKeys="locId|locDesc" searchLabels="货位编码|货位名称" searchKeys="locId|locDesc"
							 targetId="billDetailList{{idx}}_locName" targetField="locDesc"></sys:gridselect-modify>
					</td>
					...
					<td>
                        ...
                        <c:if test="${type eq 'Input'}">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group text-center">
                                    <div>
                                        <a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/outsourcinginput/outsourcingInput?type=Input"><i class="ti-angle-left"></i> 返 回</a>
                                    </div>
                                </div>
                            </div>
                        </c:if>
                        <c:if test="${type eq 'Query'}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group text-center">
                                    <div>
                                        <a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/outsourcinginput/outsourcingInput?type=Query"><i class="ti-angle-left"></i> 返 回</a>
                                    </div>
                                </div>
                            </div>
                        </c:if>
                        <c:if test="${type eq 'Post'}">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group text-center">
                                    <div>
                                        <a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/outsourcinginput/outsourcingInput?type=Post"><i class="ti-angle-left"></i> 返 回</a>
                                    </div>
                                </div>
                            </div>
                        </c:if>
                        <c:if test="${type eq 'Unpost'}">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group text-center">
                                    <div>
                                        <a class="btn btn-primary btn-block btn-lg btn-parsley" href="${ctx}/outsourcinginput/outsourcingInput?type=Unpost"><i class="ti-angle-left"></i> 返 回</a>
                                    </div>
                                </div>
                            </div>
                        </c:if>
