...
<%@ attribute name="targetId" type="java.lang.String" required="true" description="要显示的文本框的id"%>
<%@ attribute name="targetField" type="java.lang.String" required="true" description="要显示的字段"%>
		...
		top.layer.open({
		    ...
		    btn: ['确定', '关闭']
    	       ,yes: function(index, layero){ //或者使用btn1
						...
						$("#${id}Id").val(targetIds.join(",").replace(/u_/ig,""));
						$("#${id}Names").val(targetIds.join(","));
